package com.sesolutions.otp_view.smsCatcher;
        ...
        try {
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    CustomLog.e("phonNumber", "" + phoneNumber);
                    CustomLog.e("phoneNumberFilter", "" + phoneNumberFilter);

                    //TODO : currently reading all messges
