...
public class ViewThoughtCategoryFragment extends BrowseThoughtFragment implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static ViewThoughtCategoryFragment newInstance(int categoryId, String categoryName, boolean isTag) {
        ViewThoughtCategoryFragment frag = new ViewThoughtCategoryFragment();
        frag.parent = null;
