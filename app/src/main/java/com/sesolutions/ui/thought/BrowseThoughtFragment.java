...
public class BrowseThoughtFragment extends ThoughtHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static BrowseThoughtFragment newInstance(ThoughtParentFragment parent, int loggedInId, int categoryId) {
        BrowseThoughtFragment frag = new BrowseThoughtFragment();
        frag.parent = parent;
    ...
    public static BrowseThoughtFragment newInstance(ThoughtParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }


    public static BrowseThoughtFragment newInstance(int categoryId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        txtNoData = Constant.MSG_NO_THOUGHT_CREATED;
        applyTheme(v);
        return v;
    }
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new QuoteAdapter(videoList, context, this, this, Constant.FormType.CREATE_THOUGHT);
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != categoryList && null != result.getThoughtCategories())
                                            categoryList.addAll(result.getThoughtCategories());
