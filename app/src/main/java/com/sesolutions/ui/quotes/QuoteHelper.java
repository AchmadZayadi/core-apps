...
public class QuoteHelper extends CommentLikeHelper {
        ...
        try {
            switch (object1) {
                ...
                case Constant.Events.MUSIC_MAIN:
                    goToViewQuoteFragment(videoList.get(postion).getQuoteId());
                    break;
                case Constant.Events.CATEGORY:
                    if (categoryId != postion) //do not open same category again
                        openViewQuoteCategoryFragment(postion, ""+screenType, false);
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put(Constant.KEY_RESOURCE_ID, vo.getQuoteId());
                    request.params.put(Constant.KEY_RESOURCES_TYPE, Constant.ModuleName.QUOTE);
