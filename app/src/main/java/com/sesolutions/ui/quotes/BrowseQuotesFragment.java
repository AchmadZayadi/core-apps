...
public class BrowseQuotesFragment extends QuoteHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static BrowseQuotesFragment newInstance(QuotesParentFragment parent, int loggedInId, int categoryId) {
        BrowseQuotesFragment frag = new BrowseQuotesFragment();
        frag.parent = parent;
    ...
    public static BrowseQuotesFragment newInstance(QuotesParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }


    public static BrowseQuotesFragment newInstance(int categoryId) {
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new QuoteAdapter(videoList, context, this, this, Constant.GoTo.QUOTE);
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != categoryList && null != result.getQuoteCategories())
                                            categoryList.addAll(result.getQuoteCategories());
