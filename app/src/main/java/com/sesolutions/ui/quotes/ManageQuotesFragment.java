...
public class ManageQuotesFragment extends QuoteHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public QuotesParentFragment parent;
    //   public List<Quote> videoList;
    public ManageQuoteAdapter adapter;
    // private View v;
   // private View hiddenPanel;

    public static ManageQuotesFragment newInstance(QuotesParentFragment parent, int loggedInId, int categoryId) {
        ManageQuotesFragment frag = new ManageQuotesFragment();
        frag.parent = parent;
    ...
    public static ManageQuotesFragment newInstance(QuotesParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }

    public static ManageQuotesFragment newInstance(int categoryId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        txtNoData = Constant.MSG_NO_QUOTE_CREATED_YOU;
        applyTheme(v);
        return v;
    }
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new ManageQuoteAdapter(videoList, context, this, this, Constant.FormType.TYPE_MUSIC_ALBUM);
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_BROWSE_QUOTE);
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != result.getQuotes())
                                            videoList.addAll(result.getQuotes());
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        switch (object1) {
            ...
            case Constant.Events.FEED_UPDATE_OPTION:
                ...
                int quoteId = videoList.get(Integer.parseInt("" + object2)).getQuoteId();
    ...
    private void performMusicOptionClick(int quoteId, Options vo, int listPosition, int postion) {
        switch (vo.getName()) {
            ...
            case Constant.OptionType.DELETE:
                showDeleteDialog(videoList.get(listPosition).getQuoteId(), listPosition);
                break;
        }
    }
