...
public class ViewAlbumCategoryFragment extends BrowseAlbumFragment implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static ViewAlbumCategoryFragment newInstance(int categoryId, String categoryName) {
        ViewAlbumCategoryFragment frag = new ViewAlbumCategoryFragment();
        frag.listener = null;
