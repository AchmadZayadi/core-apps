...
public class ViewAlbumAdapter extends RecyclerView.Adapter<ViewAlbumAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(ViewAlbumAdapter.ContactHolder holder) {
    ...
    public ViewAlbumAdapter(List<StaggeredAlbums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
