...
public class BrowsePhotoFragment2 extends PhotoHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
...
/*    public List<Albums> videoList;
    ...
    AppCompatImageView ivImage11_st,ivImage12_st,ivImage13_st,ivImage14_st,ivBack;
    CardView rlImage11,rlImage12,rlImage13,rlImage14;
    TextView tvTitle;
    AppBarLayout appBar;
    boolean showToolbar;
    ...
    public static BrowsePhotoFragment2 newInstance(int userId, boolean showToolbar) {
        BrowsePhotoFragment2 frag = new BrowsePhotoFragment2();
        frag.loggedinId = userId;
       frag.showToolbar = showToolbar;
        return frag;
    }

    public static BrowsePhotoFragment2 newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        BrowsePhotoFragment2 frag = new BrowsePhotoFragment2();
    ...
    public void init() {
        ...
        tvTitle.setText(getStrings(R.string.photo));
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_ALBUM_PROFILE_PHOTO);
