...
public class AlbumParentFragment extends BaseFragment implements View.OnClickListener, OnUserClickedListener<Integer, Object> {
    ...
    private void setupViewPager() {
        ...
        for (String name : tabItems) {
            switch (name) {
                case BROWSE:
                    adapter.addFragment(BrowseAlbumFragment.newInstance(this, name), getString(R.string.TAB_TITLE_ALBUM_1));
                    break;
                case PHOTOS:
                    adapter.addFragment(BrowsePhotoFragment.newInstance(this, name), getString(R.string.TAB_TITLE_ALBUM_2));
                    break;
                case CATEGORY:
                    adapter.addFragment(AlbumCategoriesFragment.newInstance(this, name), getString(R.string.TAB_TITLE_ALBUM_3));
                    break;
                case MANAGE:
                    adapter.addFragment(MyAlbumFragment.newInstance(this, name), getString(R.string.TAB_TITLE_ALBUM_4));
                    break;
                case CREATE:
                    adapter.addFragment(
...
*/
   ...
   /* private void goToFormFragment() {
    ...
    private void goToSearchFragment() {
        if (selectedItem == 0) {
            fragmentManager.beginTransaction().replace(R.id.container, new SearchAlbumFragment()).addToBackStack(null).commit();
        } else {
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        switch (object1) {
            case Constant.Events.SUCCESS:
                ...
                goToViewAlbumFragment(postion, true);
