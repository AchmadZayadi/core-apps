...
public class BrowseAlbumFragment extends AlbumHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static BrowseAlbumFragment newInstance(int userId,boolean showToolbar) {
        BrowseAlbumFragment frag = new BrowseAlbumFragment();
    ...
    public static BrowseAlbumFragment newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        BrowseAlbumFragment frag = new BrowseAlbumFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        txtNoData = Constant.MSG_NO_ALBUM_CREATED2;
        applyTheme();
        if (!showToolbar) {
            ...
            ((TextView) v.findViewById(R.id.tvTitle)).setText("Album Foto");
            initScreenData();
        }
    ...
    private void updateAdapter() {
        ...
        ((TextView) v.findViewById(R.id.tvNoData)).setText(Constant.MSG_NO_ALBUM_CREATED2);
        v.findViewById(R.id.llNoData).setVisibility(videoList.size() > 0 ? View.GONE : View.VISIBLE);
        ((TextView) v.findViewById(R.id.tvNoData)).setVisibility(videoList.size() > 0 ? View.GONE : View.VISIBLE);
        if (null != listener) {
