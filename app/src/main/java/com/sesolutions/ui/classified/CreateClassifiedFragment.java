...
public class CreateClassifiedFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
...
/*    private RecyclerView mRecyclerView;
    ...
    public static CreateClassifiedFragment newinstance(int formType, String url, OnUserClickedListener<Integer, Object> listener) {
        CreateClassifiedFragment frag = new CreateClassifiedFragment();
        frag.url = url;
   ...
   /* private void setTitle() {
    ...
    public static CreateClassifiedFragment newInstance(int type, Map<String, Object> map, String url) {
