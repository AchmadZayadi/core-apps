...
public class ArticleHelper extends SpeakableContent {
    ...
    public boolean onItemClicked(Integer object1, Object screenType, int postion) {
        ...
        switch (object1) {
            ...
            case Constant.Events.FEED_UPDATE_OPTION:
                ...
                performFeedOptionClick(videoList.get(Integer.valueOf("" + screenType)).getArticleId(), vo, Integer.parseInt("" + screenType), postion);
                break;
            ...
            case Constant.Events.MUSIC_MAIN:
                goToNextScreen((BlogAdapter.ContactHolder) screenType);
                break;
    ...
    private void performFeedOptionClick(int blogId, Options vo, int actPosition, int position) {
        switch (vo.getName()) {
            case Constant.OptionType.DELETE:
                showDeleteDialog(1, blogId, actPosition);
                //callSaveFeedApi(REQ_CODE_OPTION_DELETE, Constant.URL_FEED_DELETE, actionId, vo, actPosition, position);
                break;
            case Constant.OptionType.EDIT:
                goToFormFragment(blogId);
    ...
    public void showDeleteDialog(final int REQ, final int blogId, final int position) {
        try {
            ...
            tvMsg.setText(Constant.MSG_DELETE_CONFIRMATION_ARTICLE);
            ...
            progressDialog.findViewById(R.id.bCamera).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    progressDialog.dismiss();
                    callDeleteApi(REQ, blogId, position);
    ...
    private void callDeleteApi(final int REQ, final int blogId, final int position) {
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_DELETE_ARTICLE);
                    request.params.put(Constant.KEY_ARTICLE_ID, blogId);
    ...
    public void goToFormFragment(int blogId) {
        ...
        map.put(Constant.KEY_ARTICLE_ID, blogId);
        // map.put(Constant.KEY_GET_FORM, 1);
        fragmentManager.beginTransaction().replace(R.id.container, FormFragment.newInstance(Constant.FormType.TYPE_ARTICLE_EDIT, map, Constant.URL_EDIT_ARTICLE, 0)).addToBackStack(null).commit();
    }
  ...
  /*  private void goToNextScreen(int screenType, int position) {
        switch (screenType) {
            ...
            case Constant.FormType.TYPE_MUSIC_ALBUM:
                goToViewBlogFragment(position);
                break;
        }*/

    private void goToNextScreen(BlogAdapter.ContactHolder holder) {
        ...
        try {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .replace(R.id.container, ViewArticleFragment.newInstance(videoList.get(position).getArticleId(), bundle)).addToBackStack(null).commit();
        } catch (Exception e) {
            CustomLog.e(e);
            fragmentManager.beginTransaction()
                    .replace(R.id.container
                            , ViewArticleFragment.newInstance(videoList.get(position).getArticleId()))
                    .addToBackStack(null)
                    .commit();
        }
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    int resourceId = vo.getArticleId();
