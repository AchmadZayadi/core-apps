...
public class CMusicAdapter extends RecyclerView.Adapter<CMusicAdapter.ContactHolder> {
    ...
    public CMusicAdapter(List<Albums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_music_album_basic, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            Util.showImageTintedPlaceholder(holder.ivSongImage, vo.getImageUrl(), R.drawable.placeholder_song_256);
            ...
            holder.ivAdd.setVisibility(SCREEN_TYPE == Constant.FormType.TYPE_ARTISTS || SCREEN_TYPE == Constant.FormType.TYPE_PLAYLIST ? View.GONE : View.GONE);
            //holder.fabPlay.setVisibility(TextUtils.isEmpty(vo.getSongUrl()) ? View.VISIBLE : View.INVISIBLE);
            if(vo.getSongUrl()!=null || vo.getSongselfurl()!=null){
                holder.fabPlay.setVisibility(View.VISIBLE);
            }else {
