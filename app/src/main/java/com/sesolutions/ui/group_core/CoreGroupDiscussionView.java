...
public class CoreGroupDiscussionView extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object>, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static CoreGroupDiscussionView newInstance(int topicId) {
        CoreGroupDiscussionView frag = new CoreGroupDiscussionView();
  ...
  /*  private void getMapValues() {
            ...
            if (map != null) {
                ...
                switch (resourceType) {
                    case Constant.ResourceType.PAGE:
                        ...
                        break;
                    case Constant.ResourceType.SES_GROUP:
    ...
    private void callMusicAlbumApi(final int req) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                HttpRequestVO request = new HttpRequestVO(Constant.URL_CGROUP_DISCUSSION_VIEW);
           ...
           /* v.findViewById(R.id.cvPost).setVisibility(View.VISIBLE);
            ...
            if (list != null) {
                ...
                for (final Options opt : list) {
                    ...
                    view.findViewById(R.id.cvPost).setOnClickListener(v -> onItemClicked(-1, opt.getName(), 0));
                    applyTheme(view);
    ...
    public void onStart() {
        ...
        if (activity.taskPerformed == Constant.FormType.REPLY_TOPIC
                || activity.taskPerformed == Constant.FormType.EDIT_TOPIC
        ) {
        ...
        switch (object1) {
            ...
            case Constant.Events.FEED_UPDATE_OPTION:
                ...
                if (Constant.OptionType.EDIT.equals(opt.getName())) {
                    ...
                    super.openFormFragment(Constant.FormType.EDIT_TOPIC, map, Constant.URL_EDIT_CORE_GROUP_POST);
                } else {
            ...
            progressDialog.findViewById(R.id.bCamera).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isNetworkAvailable(context)) {
                        ...
                        new ApiController(Constant.URL_DELETE_CORE_GROUP_POST, map, context, CoreGroupDiscussionView.this, -3).execute();
    ...
    private void handleOptions(String name) {
        CustomLog.e("name", "" + name);
        if (isNetworkAvailable(context)) {
            Map<String, Object> map = new HashMap<>();
            map.put(KEY_TOPIC_ID, mObjectId);

            if (Constant.OptionType.POST_REPLY.equals(name)) {
                openFormFragment(Constant.FormType.REPLY_TOPIC, map, Constant.URL_CORE_GROUP_REPLY_TOPIC);
            } else {
                map.put("watch", Constant.OptionType.STOP_WATCH_TOPIC.equals(name) ? 1 : 0);
                showBaseLoader(true);
                new ApiController(Constant.URL_CORE_GROUP_TOPIC_WATCH, map, context, this, -2).execute();
            }
        } else {
            notInternetMsg(v);
        }
