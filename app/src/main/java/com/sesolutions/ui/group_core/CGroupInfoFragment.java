...
public class CGroupInfoFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static CGroupInfoFragment newInstance(int userId, boolean isToolbarHidden) {
        CGroupInfoFragment frag = new CGroupInfoFragment();
        frag.userId = userId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_cgroup_info, container, false);
        try {
            applyTheme(v);
            /*if (!showToolbar) {
