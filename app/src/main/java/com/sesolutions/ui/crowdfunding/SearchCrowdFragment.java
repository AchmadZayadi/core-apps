...
public class SearchCrowdFragment extends CrowdFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static SearchPageFragment newInstance(String screenType) {
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SERACH_FUNDS);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_FUND, map, Constant.URL_FUND_SEARCH))
                .addToBackStack(null)
                .commit();
    }
