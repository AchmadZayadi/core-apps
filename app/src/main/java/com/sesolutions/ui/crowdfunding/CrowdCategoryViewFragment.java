...
public class CrowdCategoryViewFragment extends CrowdFragment {

    String title;

    public static CrowdCategoryViewFragment newInstance(int categoryId, String title) {
        CrowdCategoryViewFragment frag = new CrowdCategoryViewFragment();
