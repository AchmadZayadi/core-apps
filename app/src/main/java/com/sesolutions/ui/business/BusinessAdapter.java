...
import static com.sesolutions.ui.business.BusinessFragment.TYPE_CATEGORY;
import static com.sesolutions.ui.business.BusinessFragment.TYPE_MANAGE;
...
public class BusinessAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected BusinessAdapter(List<PageVo> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener) {
        this.list = list;
        this.context = cntxt;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (list.get(viewType).getType()) {
          /*  case VT_BANNER:
            ...
            default:
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_page, parent, false);
            ...
            switch (list.get(position).getType()) {
                ...
                case VT_SUGGESTION:
                    ...
                    if (holder2.adapter == null) {
                        ...
                        holder2.adapter = new SuggestionBusinessAdapter(list.get(holder2.getAdapterPosition()).getValue(), context, listener, false);
                ...
                case VT_CATEGORIES:
                    ...
                    if (holder3.adapter == null) {
                        ...
                        holder3.adapter = new SuggestionBusinessAdapter(cVo.getItems(), context, listener, false);
                ...
                case TYPE_MANAGE:
                    ...
                    final BusinessContent myBusiness = page1.getValue();
                    holder4.ivArtist.setTypeface(iconFont);
                    holder4.ivArtist.setText(Constant.FontIcon.FOLDER);
                    holder4.tvArtist.setText(TXT_IN + myBusiness.getCategory_title());
                    holder4.llArtist.setVisibility(myBusiness.getCategory_title() != null ? View.VISIBLE : View.GONE);
                    Util.showImageWithGlide(holder4.ivSongImage, myBusiness.getMainImageUrl(), context, R.drawable.placeholder_square);
                    holder4.tvSongTitle.setText(myBusiness.getTitle());
                    holder4.llLocation.setVisibility(View.GONE);
                    holder4.tvStats.setTypeface(iconFont);

                    String detail = "\uf164 " + myBusiness.getLike_count()
                            + "  \uf075 " + myBusiness.getComment_count()
                            + "  \uf06e " + myBusiness.getView_count()
                            + "  \uf004 " + myBusiness.getFavourite_count()
                            + "  \uf00c " + myBusiness.getFollow_count();
                    //   + "  \uf0c0 " + myBusiness.getMember_count();
                    holder4.tvStats.setText(detail);
                    holder4.ivOption.setVisibility(null != myBusiness.getButtons() ? View.VISIBLE : View.GONE);
                    holder4.ivOption.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            showOptionsPopUp(holder4.ivOption, holder4.getAdapterPosition(), myBusiness.getButtons());
                        }
                    });
                    holder4.cvMain.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            listener.onItemClicked(Constant.Events.MUSIC_MAIN, holder4, holder4.getAdapterPosition());
                        }
                    });
                    break;
                default:
                    ...
                    final BusinessContent vo = page.getValue();
    ...
    public static class SuggestionHolder extends RecyclerView.ViewHolder {
        ...
        protected SuggestionBusinessAdapter adapter;
