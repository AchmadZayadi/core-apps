...
public class BusinessInfoFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static BusinessInfoFragment newInstance(int userId) {
        BusinessInfoFragment frag = new BusinessInfoFragment();
        frag.mBusinessId = userId;
        return frag;
    }

    boolean istoolbar=false;
    public static BusinessInfoFragment newInstance(int userId,boolean istoolbar) {
        BusinessInfoFragment frag = new BusinessInfoFragment();
        frag.mBusinessId = userId;
    ...
    private void openMoreMemberFragment(String type) {
        ...
        bundle.putInt(Constant.KEY_ID, mBusinessId);
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_BUSINESS_INFO);
