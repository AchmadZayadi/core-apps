...
public class VideoControllerView extends MediaController {
    ...
    protected View makeControllerView() {
        ...
        mRoot = inflate.inflate(R.layout.story_media_controller, null);
    ...
    public void hide() {
        ...
        try {
            ...
            CustomLog.d("MediaController", "already removed");
        }
        mShowing = false;
    }
    ...
    public void updateFullScreen() {
        ...
        if (mPlayer.isFullScreen()) {
            mFullscreenButton.setImageResource(R.drawable.placeholder_square);//ic_media_fullscreen_shrink);
        } else {
            mFullscreenButton.setImageResource(R.drawable.image_placeholder);//ic_media_fullscreen_stretch);
        }
    }
