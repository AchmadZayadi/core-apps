...
import com.sesolutions.ui.dashboard.AttributionAdapter;
import com.sesolutions.utils.Constant;
import com.sesolutions.utils.CustomLog;

import java.util.List;

public class AttributionPopup extends RelativePopupWindow implements OnUserClickedListener<Integer, Object> {

    private final OnUserClickedListener<Integer, Object> listener;
    private final int position;
    private final List<Attribution> optionList;
    private View v;


    public AttributionPopup(Context context, int position, OnUserClickedListener<Integer, Object> listener, List<Attribution> optionList) {
    ...
    private void setFeedUpdateRecycleView(Context context) {
        try {
            ...
            AttributionAdapter adapterFeed = new AttributionAdapter(optionList, context, this);
    ...
    public void showOnAnchor(@NonNull View anchor, int vertPos, int horizPos, int x, int y, boolean fitInScreen) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
           ...
           /* Animation animator = AnimationUtils.makeInAnimation(anchor.getContext(), true);
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        listener.onItemClicked(object1, position, postion);
        dismiss();
        return false;
    }
}