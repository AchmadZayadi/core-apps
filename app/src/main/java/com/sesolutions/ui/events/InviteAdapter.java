...
public class InviteAdapter extends RecyclerView.Adapter<InviteAdapter.ContactHolder> {
    ...
    public InviteAdapter(List<Options> list, Context cntxt, OnUserClickedListener<Integer, Object> listener) {
        this.list = list;
        this.context = cntxt;
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_invite_member, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            holder.tvCb.setText(vo.getLabel());
            // holder.tvText.setTextColor(text1);
            holder.cb.setChecked("1".equals(vo.getValue()));
            holder.llCb.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onItemClicked(Constant.Events.MENU_MAIN, vo.getValue(), holder.getAdapterPosition());
                }
            });
