...
public class CreateAlbumForm extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
    ...
    private void init() {
        ((TextView) v.findViewById(R.id.tvTitle)).setText(R.string.TITLE_ADD_ALBUM);
    ...
    public static CreateAlbumForm newInstance(int formType, Map<String, Object> map, String url) {
        CreateAlbumForm frag = new CreateAlbumForm();
        frag.url = url;
        frag.map = map;
