...
public class SearchEventFragment extends UpcomingEventFragment implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static SearchEventFragment newInstance(String selectedScreen) {
    ...
    public void init() {
        ...
        switch (selectedScreen) {
            case TYPE_BROWSE_LIST:
                hintId = R.string.TXT_SERACH_LIST;
                SEARCH_KEY = Constant.KEY_TITLE_NAME;
                filterUrl = Constant.URL_FILTER_EVENT_LIST;
                break;
            case TYPE_BROWSE_HOST:
                hintId = R.string.TXT_SERACH_HOST;
                filterUrl = Constant.URL_FILTER_HOST;
                SEARCH_KEY = Constant.KEY_TITLE_NAME;
                break;
            default:
                hintId = R.string.TXT_SERACH_EVENT;
                filterUrl = Constant.URL_FILTER_EVENT;
