...
public class DiscussionFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object>/*, SwipeRefreshLayout.OnRefreshListener*/ {
    ...
    public static DiscussionFragment newInstance(Map<String, Object> map) {
        DiscussionFragment frag = new DiscussionFragment();
        frag.map = map;
        return frag;
    }

    boolean isshowtoolbar=false;
    public static DiscussionFragment newInstance(Map<String, Object> map,boolean isshowtoolbar) {
        DiscussionFragment frag = new DiscussionFragment();
        frag.map = map;
        frag.isshowtoolbar = isshowtoolbar;
        return frag;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        if (!isshowtoolbar) {
            ...
            ((TextView) v.findViewById(R.id.tvTitle)).setText(R.string.discussionid);
            initScreenData();
        ...
        try {
            switch (v.getId()) {
                ...
                case R.id.cvPost:
                    ...
                    super.openFormFragment(Constant.FormType.CREATE_DISCUSSTION, map, Constant.URL_CREATE_DISCUSSION);
                    break;
            }
        } catch (Exception e) {
            CustomLog.e(e);
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        switch (object1) {
            ...
            case Constant.Events.MUSIC_MAIN:
                super.goToViewDiscussionFragment(categoryList.get(postion).getTopicId());
                break;
