...
public class ViewEventCategoryFragment extends UpcomingEventFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static ViewEventCategoryFragment newInstance(int categoryId, String categoryName) {
    ...
    public static ViewEventCategoryFragment newInstance(Category category) {
        ViewEventCategoryFragment frag = new ViewEventCategoryFragment();
        frag.parent = null;
