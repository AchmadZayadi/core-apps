...
public class EventAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EventAdapter(List<CommonVO> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener) {
        this.list = list;
        this.context = cntxt;
        ...
        switch (type) {
            case UpcomingEventFragment.TYPE_MANAGE:
                switch (subType) {
                    ...
                    case "lists":
                        view = LayoutInflater.from(parent.getContext()).inflate(viewType % 2 == 0 ? R.layout.item_event_list : R.layout.item_event_list_even, parent, false);
                        return new BrowseListHolder(view);
                    default:
            ...
            case UpcomingEventFragment.TYPE_BROWSE_LIST:
                //left and right items has different UI
                View view = LayoutInflater.from(parent.getContext()).inflate(viewType % 2 == 0 ? R.layout.item_event_list : R.layout.item_event_list_even, parent, false);
                return new BrowseListHolder(view);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder parentHolder, int position) {
        ...
        try {
            ...
            if (parentHolder instanceof ContactHolder) {
                ...
                Log.e("CalenderTime",""+vo.getCalanderStartTime());
                Log.e("CalenderENDTime",""+vo.getCalanderEndTime());
                ...
                holder.sbvFavorite.setVisibility(vo.canLike() ? View.VISIBLE : View.GONE);
                ...
                holder.ivAdd.setVisibility(vo.canAddToList() ? View.VISIBLE : View.GONE);

                holder.ivLike.setOnClickListener(v -> listener.onItemClicked(Constant.Events.MUSIC_LIKE, "" + vo, holder.getAdapterPosition()));
                holder.ivAdd.setOnClickListener(v -> listener.onItemClicked(Constant.Events.MUSIC_ADD, "" + vo, holder.getAdapterPosition()));
    ...
    public static class ContactHolder extends RecyclerView.ViewHolder {
        ...
        public ContactHolder(View itemView) {
            ...
            try {
                ...
                ivAdd = itemView.findViewById(R.id.ivFollow);
