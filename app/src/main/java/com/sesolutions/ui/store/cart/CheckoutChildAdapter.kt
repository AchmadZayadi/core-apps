...
import com.sesolutions.ui.customviews.itemcounterview.IncDecView
...
//            holder.qtyCount.setStartCounterValue(cVo.quantity.toString())
            ...
            holder.spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
                ...
                override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                    ...
                    if (CheckoutFragment.qtyMap.containsKey("quantity_${cVo.productId}")){
//                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                            CheckoutFragment.qtyMap.replace("quantity_${cVo.productId}", selectedItem)
//                        }

                    }else {
                        CheckoutFragment.qtyMap["quantity_${cVo.buttons[0].id}"] = selectedItem
                    }
                }
            }
