...
class CheckoutFragment : BaseFragment(), View.OnClickListener, OnLoadMoreListener, androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener, OnUserClickedListener<Int, Any> {
    ...
    fun setRecyclerView() {
        try {
            ...
            adapter = CheckoutAdapter(cartDatalist, context, this, this)
