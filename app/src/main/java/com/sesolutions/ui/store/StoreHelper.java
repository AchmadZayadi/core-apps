...
//                        openViewPageCategoryFragment(postion, "" + screenType);
                ...
                case Constant.Events.FEED_UPDATE_OPTION:
                    ...
                    //get clicked option
//                    Options opt = videoList.get(selectedVo).getProducts().get(Integer.parseInt("" + screenType)).getMenus().get(postion);
                ...
                case Constant.OptionType.EDIT:
                    ...
                    fragmentManager.beginTransaction()
                            .replace(R.id.container,
                                    CreateEditStoreFragment.newInstance(Constant.FormType.EDIT_STORE, map, Constant.URL_STORE_EDIT, null))
                            .addToBackStack(null)
                            .commit();
                    break;
