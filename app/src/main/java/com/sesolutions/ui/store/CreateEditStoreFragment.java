...
public class CreateEditStoreFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditStoreFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateEditStoreFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateEditStoreFragment fragment = new CreateEditStoreFragment();
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.CREATE_STORE ? R.string.title_create_store : R.string.title_edit_store));
