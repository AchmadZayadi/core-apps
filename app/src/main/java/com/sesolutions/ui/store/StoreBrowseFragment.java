...
public class StoreBrowseFragment extends StoreBrowseHelper<StoreAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static StoreBrowseFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
        StoreBrowseFragment frag = new StoreBrowseFragment();
        frag.parent = parent;
    ...
    public static StoreBrowseFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }

    public static StoreBrowseFragment newInstance(String TYPE, OnUserClickedListener<Integer, Object> parent) {
        StoreBrowseFragment frag = newInstance(parent, -1, -1);
        frag.selectedScreen = TYPE;
        return frag;
    }

    public static StoreBrowseFragment newInstance(String TYPE, int storeId) {
        StoreBrowseFragment frag = newInstance(null, -1, -1);
        frag.selectedScreen = TYPE;
    ...
    public static StoreBrowseFragment newInstance(int categoryId) {
