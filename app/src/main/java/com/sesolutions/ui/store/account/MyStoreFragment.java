...
import com.sesolutions.ui.store.SearchStoreFragment;
import com.sesolutions.ui.store.StoreAdapter;
import com.sesolutions.ui.store.StoreHelper;
...
public class MyStoreFragment extends StoreHelper<StoreAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void callStoreApi(final int req) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                ...
                HttpRequestVO request = new HttpRequestVO(URL.MY_STORE); //url will change according to screenType
