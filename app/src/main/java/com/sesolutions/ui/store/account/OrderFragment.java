...
public class OrderFragment extends BaseFragment implements View.OnClickListener, OnUserClickedListener<Integer, Object>, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new OrderAdapter(orderList, context, this);
