...
public class SearchProductFragment extends ProductFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static SearchPageFragment newInstance(String screenType) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        applyTheme(v);
        selectedScreen = MenuTab.Store.PRODUCT;
        v.findViewById(R.id.rlSearchFilter).setVisibility(View.GONE);
        init();
        txtNoData = R.string.MSG_NO_PRODUCT_FOUND;
        setRecyclerView();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SERACH_PRODUCT);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_PRODUCT, map, Constant.URL_SEARCH_PRODUCT))
                .addToBackStack(null)
                .commit();
    }
