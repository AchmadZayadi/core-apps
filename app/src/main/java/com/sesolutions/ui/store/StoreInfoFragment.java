...
public class StoreInfoFragment extends BaseFragment {
    ...
    public static StoreInfoFragment newInstance(int userId) {
    ...
    public static StoreInfoFragment newInstance(int userId,boolean showToolbar) {
        StoreInfoFragment frag = new StoreInfoFragment();
        frag.mStoreId = userId;
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_STORE_INFO);
