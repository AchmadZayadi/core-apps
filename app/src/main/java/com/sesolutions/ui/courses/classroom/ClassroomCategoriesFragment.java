...
public class ClassroomCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String> {
    ...
    public ClassroomParentFragment parent;
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_CLASSROOM_CATEGORY_VIEW);
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != parent)
                                            parent.onItemClicked(Constant.Events.SET_LOADED, TYPE_CATEGORY, 1);
...
//            parent.updateTotal(1, categoryList.size());
    ...
    public static ClassroomCategoriesFragment newInstance(ClassroomParentFragment parent) {
        ClassroomCategoriesFragment frag = new ClassroomCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewClassroomCategoryFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
}
