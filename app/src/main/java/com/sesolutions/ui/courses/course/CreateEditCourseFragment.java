...
public class CreateEditCourseFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditStoreFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateEditCourseFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateEditCourseFragment fragment = new CreateEditCourseFragment();
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.CREATE_COURSE ? R.string.CREATE_COURSE : R.string.title_edit_course));
