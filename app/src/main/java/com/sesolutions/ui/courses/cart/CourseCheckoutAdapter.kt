...
class CourseCheckoutAdapter(private var list: List<CheckoutResponse.Result.CartData>,
                      private val context: Context,
                      private var loadListener: OnLoadMoreListener,
                      private val listener: OnUserClickedListener<Int, Any>) : androidx.recyclerview.widget.RecyclerView.Adapter<CourseCheckoutAdapter.CategoryHolder>(){
