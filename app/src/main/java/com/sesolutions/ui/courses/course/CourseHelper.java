...
public class CourseHelper<T extends RecyclerView.Adapter> extends CommentLikeHelper implements View.OnClickListener {
    ...
    public List<CourseVo> videoList;
    public T adapter;
    public List<Category> categoryList;
    public CourseResponse.Result result;
        ...
        try {
            switch (object1) {
                ...
                case Constant.Events.OPEN_WISHLIST:
                    CourseUtil.openViewWishlistFragmnet(fragmentManager, (String) screenType, videoList.get(postion).getItem().getWishListId());
                    break;
                case Constant.Events.MUSIC_MAIN:
                    openViewCourseFragment(videoList.get(postion).getItem().getCourse_id());
                    break;
                ...
                case Constant.Events.PAGE_SUGGESTION_MAIN:
                    openViewCourseFragment(postion);
                    break;
                ...
                case Constant.Events.FEED_UPDATE_OPTION:
                    ...
                    switch (opt.getName()) {
                        ...
                        case Constant.OptionType.DELETE:
                            showWishlistDeleteDialog(Integer.parseInt("" + screenType));
                            break;
                        ...
                        case Constant.OptionType.EDIT:
                            ...
                            map2.put(Constant.KEY_WISHLIST_ID, videoList.get(postion).getItem().getWishListId());
                            fragmentManager.beginTransaction().replace(R.id.container,
                                    AddToPlaylistFragment.newInstance(Constant.FormType.TYPE_EDIT_WISHLIST, map2, Constant.URL_WISHLIST_EDIT))
...
//                                        }
                ...
                case Constant.OptionType.EDIT:
                    ...
                    fragmentManager.beginTransaction()
                            .replace(R.id.container,
                                    CreateEditCourseFragment.newInstance(Constant.FormType.EDIT_PAGE, map, Constant.URL_EDIT_COURSE, null))
                            .addToBackStack(null)
                            .commit();
                    break;
    ...
    public void showWishlistDeleteDialog(final int position) {
        try {
            if (null != progressDialog && progressDialog.isShowing()) {
                progressDialog.dismiss();
            }
            ...
            progressDialog.findViewById(R.id.bCamera).setOnClickListener(v -> {
                progressDialog.dismiss();
                callDeleteApi(REQ_DELETE, position, Constant.URL_WISHLIST_DELETE, -1);
    ...
    private void callLikeApi(final int REQ_CODE, final int position, String url, final int optionPosition) {
        ...
        if (isNetworkAvailable(context)) {
            final CourseContent vo = videoList.get(position).getItem();
    ...
    private void callDeleteApi(final int REQ_CODE, final int position, String url, final int optionPosition) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                ...
                HttpRequestVO request = new HttpRequestVO(url);
                request.params.put(Constant.KEY_TYPE, vo.getWishListId());
    ...
    public void updateItemLikeFavorite(int REQ_CODE, int position, CourseContent vo, boolean showAnimation) {
