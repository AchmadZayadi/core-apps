...
public class ClassroomMapFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object> {
  ...
  /*  public static GroupMemberFragment newInstance(int resourceId) {
    ...
    public static ClassroomMapFragment newInstance(Bundle bundle) {
        ClassroomMapFragment frag = new ClassroomMapFragment();
        frag.bundle = bundle;
        return frag;
    }
