...
import com.sesolutions.ui.courses.course.SearchCourseFragment;
...
public class MyClassroomFragment extends ClassroomHelper<ClassroomAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_my_classroom, container, false);
        applyTheme(v);
        initScreenData();
        return v;
    }
    ...
    public void callStoreApi(final int req) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                ...
                HttpRequestVO request = new HttpRequestVO(URL.URL_MY_CLASSROOM); //url will change according to screenType
