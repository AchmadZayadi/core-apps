...
import com.sesolutions.ui.courses.course.CourseHelper;
...
public class MyCourseWishlist extends CourseHelper<CourseAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void callProductApi(final int req) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                ...
                HttpRequestVO request = new HttpRequestVO(URL.URL_BROWSE_COURSEWISHLIST); //url will change according to screenType
...
//                                    }
                                    ...
                                    if (null != result.getCourses()) {
                                        videoList.add(new CourseVo(selectedScreen, result.getCourses()));
