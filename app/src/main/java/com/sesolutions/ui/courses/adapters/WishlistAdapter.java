...
public class WishlistAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WishlistAdapter(List<CourseVo> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener) {
        this.list = list;
        this.context = cntxt;
...
//                            + "  \uf004 " + myPage.getFavourite_count()
                    ...
                    holder5.cvMain.setOnClickListener(v -> listener.onItemClicked(Constant.Events.OPEN_WISHLIST, MY_WISHLIST, myPage.getCourse_id()));
                    break;
                case TYPE_MANAGE:
...
//                    holder4.tvArtist.setText(TXT_IN + myPage.getCategory_title());
                ...
                default:
                    ...
                    holder.tvDiscount.setVisibility(!TextUtils.isEmpty(vo.getDiscount()) ? View.VISIBLE : View.GONE);
                    ...
                    if (!TextUtils.isEmpty(vo.getCategory_title())) {
                        ...
                        String desc = "Posted in " +"<b>"+ vo.getCategory_title() +"</b>" + " By " + "<b>" + vo.getOwner_title() + "</b>" ;
                        holder.tvLocation.setText(Html.fromHtml(desc));
