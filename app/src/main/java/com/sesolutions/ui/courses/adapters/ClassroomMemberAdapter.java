...
public class ClassroomMemberAdapter extends RecyclerView.Adapter<ClassroomMemberAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull ClassroomMemberAdapter.ContactHolder holder) {
    ...
    public ClassroomMemberAdapter(List<UserMaster> list, Context cntxt, OnLoadMoreListener loadMoreListener, OnUserClickedListener<Integer, Object> listener) {
