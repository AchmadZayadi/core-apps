...
public class SuggestionClassroomAdapter extends RecyclerView.Adapter<SuggestionClassroomAdapter.ContactHolder> {
    ...
    public SuggestionClassroomAdapter(List<ClassroomContent> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, boolean isRecent) {
        this.list = list;
        this.context = cntxt;
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(isRecent ? R.layout.item_page_recent : R.layout.item_classroom_suggestion, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            holder.rlMain.setOnClickListener(v -> listener.onItemClicked(Constant.Events.CLASSROOM_SUGGESTION_MAIN, "" + holder, vo.getClassroom_id()));
