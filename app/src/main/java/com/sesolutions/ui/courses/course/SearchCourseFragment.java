...
public class SearchCourseFragment extends CourseFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static SearchPageFragment newInstance(String screenType) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        selectedScreen = MenuTab.Course.BROWSE_COURSE;
        v.findViewById(R.id.rlSearchFilter).setVisibility(View.GONE);
        init();
        txtNoData = R.string.MSG_NO_COURSE_FOUND;
        setRecyclerView();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SEARCH_COURSE);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_COURSE, map, Constant.URL_SEARCH_COURSE))
                .addToBackStack(null)
                .commit();
    }
