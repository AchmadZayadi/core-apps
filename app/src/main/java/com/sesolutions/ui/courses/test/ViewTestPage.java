...
import static com.sesolutions.utils.URL.URL_VIEW_TEST;
...
public class ViewTestPage extends BlogHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_test, container, false);
        applyTheme(v);
        init();
        callMusicAlbumApi(1);
    ...
    public void init() {
        ...
        v.findViewById(R.id.mTextField).setOnClickListener(this);
...
//        ((TextView) v.findViewById(R.id.ivUserTitle)).setText(Constant.FontIcon.USER);
    ...
    private void updateUpperLayout() {
        try {
            ...
            ((TextView) v.findViewById(R.id.tvDescription)).setText(Html.fromHtml(album.getDescription()));
...
//                    request.params.put(Constant.KEY_RESOURCES_TYPE, album.ge());
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(URL_VIEW_TEST);
             ...
             /*       if (!TextUtils.isEmpty(searchKey))
                    ...
                    request.headres.put(Constant.KEY_COOKIE, getCookie());
                    request.params.put(Constant.KEY_AUTH_TOKEN, SPref.getInstance().getToken(context));
                    request.params.put(Constant.KEY_TEST_ID, albumId);
    ...
    public static ViewTestPage newInstance(int albumId, boolean comment) {
        ViewTestPage frag = new ViewTestPage();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewTestPage newInstance(int albumId, Bundle bundle) {
        ViewTestPage frag = new ViewTestPage();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewTestPage newInstance(int albumId) {
        return ViewTestPage.newInstance(albumId, false);
    }
        ...
        try {
            ...
            switch (opt.getName()) {
                case Constant.OptionType.EDIT:
                    goToFormFragment(album.getLecture_id());
                    break;
