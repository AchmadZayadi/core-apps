...
public class CourseOrderAdapter extends RecyclerView.Adapter<CourseOrderAdapter.ContactHolder> {
    ...
    public CourseOrderAdapter(List<Order> list, Context cntxt, OnUserClickedListener<Integer, Object> listener) {
        this.list = list;
        this.context = cntxt;
        ...
        // this.lo  adListener = loadListener;
    }

    @NotNull
    @Override
    public CourseOrderAdapter.ContactHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order, parent, false);
        return new CourseOrderAdapter.ContactHolder(view);
    }
...
//            holder.ivVideoForground.setVisibility(vo.getType().equalsIgnoreCase(Constant.ACTIVITY_TYPE_ALBUM) ? View.GONE : View.VISIBLE);
            ...
            holder.mcvViewOrder.setOnClickListener(v -> listener.onItemClicked(Constant.Events.VIEW_ORDER, "", vo.getOrderId()));
