...
public class MyTestFragment extends TestHelper<TestAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void callStoreApi(final int req) {
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
                ...
                HttpRequestVO request = new HttpRequestVO(URL.URL_MY_TEST); //url will change according to screenType
                ...
                Handler.Callback callback = new Handler.Callback() {
                    ...
                    public boolean handleMessage(Message msg) {
                        ...
                        try {
                            ...
                            CustomLog.e("response_my_tests", "" + response);
                            if (response != null) {
