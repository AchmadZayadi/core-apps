...
public class CreateLectureFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditStoreFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateLectureFragment newInstance(int courseId, int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateLectureFragment fragment = new CreateLectureFragment();
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.CREATE_COURSE ? R.string.CREATE_COURSE : R.string.CREATE_LECTURE));
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put(Constant.KEY_COURSE_ID, courseId);
