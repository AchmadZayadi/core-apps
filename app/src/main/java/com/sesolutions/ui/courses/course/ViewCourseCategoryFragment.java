...
public class ViewCourseCategoryFragment extends CourseFragment implements View.OnClickListener, OnLoadMoreListener {
...
//    }
    ...
    public static ViewCourseCategoryFragment newInstance(int categoryId, String categoryName) {
        ViewCourseCategoryFragment frag = new ViewCourseCategoryFragment();
        frag.parent = null;
