...
public class MapAdapter extends RecyclerView.Adapter<MapAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull MapAdapter.ContactHolder holder) {
    ...
    public MapAdapter(List<LocationActivity> list, Context cntxt, OnLoadMoreListener loadMoreListener, OnUserClickedListener<Integer, Object> listener) {
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_c_map, parent, false);
