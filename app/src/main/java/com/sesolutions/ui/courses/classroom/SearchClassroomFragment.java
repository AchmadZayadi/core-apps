...
public class SearchClassroomFragment extends ClassroomFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static SearchPageFragment newInstance(String screenType) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        init();
        txtNoData = R.string.MSG_NO_CLASSROOM_FOUND;
        setRecyclerView();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SEARCH_CLASSROOM);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_COURSE, map, Constant.URL_SEARCH_CLASSROOM))
                .addToBackStack(null)
                .commit();
    }
