...
public class CourseCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String> {
    ...
    public View v;
    public CourseParentFragment parent;
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_COURSE_CATEGORY_VIEW);
...
//            parent.updateTotal(1, categoryList.size());
    ...
    public static CourseCategoriesFragment newInstance(CourseParentFragment parent) {
        CourseCategoriesFragment frag = new CourseCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewCourseCategoryFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
}
