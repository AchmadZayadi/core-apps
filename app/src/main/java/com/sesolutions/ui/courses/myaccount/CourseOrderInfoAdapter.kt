...
class CourseOrderInfoAdapter(private val list: List<ViewCourseOrder.Result.Otherinfo>)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val movie: ViewCourseOrder.Result.Otherinfo = list[position]
        holder.bind(movie)
    }
...
class ViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
    ...
    fun bind(movie: ViewCourseOrder.Result.Otherinfo) {
