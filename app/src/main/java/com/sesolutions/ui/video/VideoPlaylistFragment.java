...
public class VideoPlaylistFragment extends VideoHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        txtNoData = Constant.MSG_NO_PLAYLIST_AVAILABLE;
        applyTheme(v);
        return v;
    }
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new VideoAdapter(videoList, context, this, this, Constant.FormType.TYPE_PLAYLIST);
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_BROWSE_PLAYLIST_VIDEO);
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != result.getPlaylists())
                                            videoList.addAll(result.getPlaylists());
    ...
    public static VideoPlaylistFragment newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        VideoPlaylistFragment frag = new VideoPlaylistFragment();
