...
import com.sesolutions.responses.videos.VideoBrowse2;
...
public class VideoChannelFragment extends VideoHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    private RecyclerView recyclerView;
    private boolean isLoading;
    private int REQ_LOAD_MORE = 2;
    public String searchKey;
    public com.sesolutions.responses.videos.Result2 result;
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        VideoBrowse2 resp = new Gson().fromJson(response, VideoBrowse2.class);
                                        result = resp.getResult();
                                 //       result.getChannels().get(0).getFollow();
    ...
    public static VideoChannelFragment newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        VideoChannelFragment frag = new VideoChannelFragment();
