...
public class ViewVideoFragment extends CommentLikeHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        if (SPref.getInstance().getDefaultInfo(getActivity(), Constant.KEY_APPDEFAULT_DATA).getResult().isIs_core_activity()) {
            mainmenuid.setVisibility(View.GONE);
        }else {
            mainmenuid.setVisibility(View.VISIBLE);
        }
...
//    }
    ...
    private void init() {
        try {
            ...
            mainmenuid = v.findViewById(R.id.mainmenuid);
    ...
    public void updateUpperLayout() {
        try {
            int totalrating= (int) videoVo.getRating().getTotalRatingAverage();

            setRatingStarsnew(totalrating);
            ...
            Util.showImageWithGlide123(ivUserImage, ""+videoVo.getUserImage(),  R.drawable.dummy_profile);
            ...
            ((ImageView) v.findViewById(R.id.tvImageLater)).setColorFilter(videoVo.getHasWatchlater() ? cGrey : cPrimary);
            ((TextView) v.findViewById(R.id.tvLater)).setTextColor(videoVo.getHasWatchlater() ? cGrey : cPrimary);
        } catch (Exception e) {
    ...
    public void setRatingStars(int newRating) {
        if (-1 != newRating) {
            if (videoVo.getRating().getCode() != 100) {
                Util.showSnackbar(v, getStrings(R.string.ratingsuccess));
            } else {
    ...
    public void setRatingStarsnew(int newRating) {
                    ...
                    if (!TextUtils.isEmpty(rcType)) {
                        switch (rcType) {
                            ...
                            case Constant.ResourceType.BUSINESS_VIDEO:
                                ...
                                break;
                            case Constant.ResourceType.GROUP_VIDEO:
                            case Constant.ResourceType.GROUP_VIDEO2:
    ...
    private void goToFormFragment() {
        ...
        fragmentManager.beginTransaction().replace(R.id.container,
                FormFragment.newInstance(Constant.FormType.KEY_EDIT_VIDEO, map, url,this))
                .addToBackStack(null)
                .commit();
    }
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        onBackPressed();
                                        BaseActivity.backcoverchange = Constant.TASK_DELETE_Video;
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        try {
            ...
            }else if(object1== Constant.FormType.KEY_EDIT_VIDEO){
                callMusicAlbumApi(1);
            }
        } catch (Exception e) {
            CustomLog.e(e);
