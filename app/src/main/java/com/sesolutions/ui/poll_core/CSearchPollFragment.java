...
public class CSearchPollFragment extends CBrowsePollsFragment implements View.OnClickListener {


    private AppCompatEditText etMusicSearch;
    private int isBackFrom;

    public static CSearchPollFragment newInstance(int loggedinId) {
        CSearchPollFragment frag = new CSearchPollFragment();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(getStrings(R.string.TXT_SEARCH_POLLS));
    ...
    public void onClick(View v) {
        try {
            switch (v.getId()) {
                ...
                case R.id.ivFilter:
                    activity.filteredMap = null;
                    openFormFragment(Constant.FormType.FILTER_POLL, new HashMap<>(), Constant.URL_POLL_SEARCH);
                    break;
                case R.id.ivMic:
                    closeKeyboard();
