...
import com.sesolutions.ui.bookings.ProfessionalFragment;
import com.sesolutions.ui.bookings.ServiceFragment;
...
public class ViewJobFragment extends JobHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener, TabLayout.OnTabSelectedListener {
    ...
    TextView jobtitle,companyname,expriense;
    public ViewPager viewPager;
    public TabLayout tabLayout;
    Button applyforjobid,followid;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_job, container, false);
        applyTheme(v);
        ...
        applyforjobid = v.findViewById(R.id.applyforjobid);
        ...
        applyforjobid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoApplyjob(jobsResponse.getJob_id());
            }
        });
        followid.setVisibility(View.GONE);
    ...
    public void setupViewPager() {
        ...
        adapter.addFragment(Jobbrowsefragment.newInstance(jobsResponse!=null ?""+jobsResponse.getBody():"JOB desc", 1,jobsResponse), "Job Description");
        adapter.addFragment(JobbrowseContactfragment.newInstance(jobsResponse!=null ?""+jobsResponse.getCompany_description():"JOB desc", 1,jobsResponse), "Contact Information");
    ...
    private void updateUpperLayout() {
        try {
         ...
         //   Util.showImageWithGlide(ivUserImage, album.getUserImage(), context, R.drawable.placeholder_square);
            ...
            try {
                ivSaveFeed.setImageDrawable(jobsResponse.getShortcut_save().isIs_saved() ?  dUnsave:dSave);
            }catch (Exception ex){
                ex.printStackTrace();
                ivSaveFeed.setVisibility(View.GONE);
                ivFbShare.setVisibility(View.GONE);
                ivWhatsAppShare.setVisibility(View.GONE);
                ivImageShare.setVisibility(View.GONE);
            }

            companyname.setVisibility(View.VISIBLE);

            if(jobsResponse!=null && jobsResponse.getExperience()!=null && jobsResponse.getLocation()!=null && jobsResponse.getLocation().length()>0){
            ...
            }else if(jobsResponse!=null && jobsResponse.getLocation()!=null  && jobsResponse.getLocation().length()>0){
                companyname.setText(Constant.FontIcon.MAP_MARKER+" "+jobsResponse.getLocation());
            }else {
                companyname.setVisibility(View.GONE);
            }
            expriense.setText("Posted by"+jobsResponse.getJob_contact_name()+ " on "+Util.changeDateFormat(context,jobsResponse.getCreationDate()));
   ...
   /* private void unfilledAllStar() {
    ...
    public static ViewJobFragment newInstance(int albumId, boolean comment) {
    ...
    public static ViewJobFragment newInstance(int albumId, Bundle bundle) {
        ViewJobFragment frag = new ViewJobFragment();
        frag.JobId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewJobFragment newInstance(int albumId) {
        return ViewJobFragment.newInstance(albumId, false);
    }
