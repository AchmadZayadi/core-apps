...
public class Jobbrowsefragment extends BookingHelper<ProfessionalAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static Jobbrowsefragment newInstance(Jobbrowsefragment parent, int loggedInId, int categoryId) {
        Jobbrowsefragment frag = new Jobbrowsefragment();
        frag.parent = parent;
    ...
    public static Jobbrowsefragment newInstance(String loggedInIdlkjk,Jobbrowsefragment parent) {
        return newInstance( loggedInIdlkjk, parent);
    }



    public static Jobbrowsefragment newInstance(String TYPE, int businessId, JobsResponse jobsResponse) {
        Jobbrowsefragment frag = newInstance(null, -1, -1);
    ...
    public static Jobbrowsefragment newInstance(int categoryId) {
