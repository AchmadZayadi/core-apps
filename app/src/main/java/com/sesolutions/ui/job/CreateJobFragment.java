...
public class CreateJobFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
...
/*    private RecyclerView mRecyclerView;
    ...
    public static CreateJobFragment newinstance(int formType, String url, OnUserClickedListener<Integer, Object> listener) {
        CreateJobFragment frag = new CreateJobFragment();
        frag.url = url;
   ...
   /* private void setTitle() {
    ...
    public static CreateJobFragment newInstance(int type, Map<String, Object> map, String url) {
