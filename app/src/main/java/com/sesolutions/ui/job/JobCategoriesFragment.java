...
public class JobCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String> {
    ...
    public View v;
    public JobParentFragment parent;
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new CategoryAdapter(categoryList, context, this, this, Constant.FormType.TYPE_CATEGORY_JOB);
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_JOB_CATEGORIES);
    ...
    public static JobCategoriesFragment newInstance(JobParentFragment parent) {
        JobCategoriesFragment frag = new JobCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewJobCategoryFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
}
