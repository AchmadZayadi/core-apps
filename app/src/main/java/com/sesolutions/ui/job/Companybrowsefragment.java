...
public class Companybrowsefragment extends BookingHelper<ProfessionalAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    TextView titledesc,titleheader;
    RelativeLayout llNoData;
    TextView txtData;
    TextView txt3_value,txt2_value,txt1_value;

    JobsResponse jobsResponse;

    public static Companybrowsefragment newInstance(Companybrowsefragment parent, int loggedInId, int categoryId) {
        Companybrowsefragment frag = new Companybrowsefragment();
        frag.parent = parent;
    ...
    public static Companybrowsefragment newInstance(String loggedInIdlkjk, Companybrowsefragment parent) {
        return newInstance( loggedInIdlkjk, parent);
    }



    public static Companybrowsefragment newInstance(String TYPE, int businessId, JobsResponse jobsResponse) {
        Companybrowsefragment frag = newInstance(null, -1, -1);
    ...
    public static Companybrowsefragment newInstance(int categoryId) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_common_list_refresh5, container, false);
        applyTheme(v);
        init();
        return v;
    }
    ...
    public void init() {
        ...
        titledesc = v.findViewById(R.id.titledesc);
        ...
        titleheader = v.findViewById(R.id.titleheader);
        ...
        if(jobdescrption.length()>0){
         ...
         //   txt1_value.setText(Html.fromHtml(jobdescrption));
