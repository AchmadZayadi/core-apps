...
public class ApplyJobFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
...
/*    private RecyclerView mRecyclerView;
    ...
    public static ApplyJobFragment newinstance(int formType, String url, OnUserClickedListener<Integer, Object> listener) {
        ApplyJobFragment frag = new ApplyJobFragment();
        frag.url = url;
   ...
   /* private void setTitle() {
    ...
    public static ApplyJobFragment newInstance(int type, Map<String, Object> map, String url) {
