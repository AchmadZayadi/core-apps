...
public class MyJobsFragment extends JobHelper implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static MyJobsFragment newInstance(int userId, boolean showToolbar) {
        MyJobsFragment frag = new MyJobsFragment();
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new JobAdapter(videoList, context, this, this, Constant.FormType.MY_TYPE_JOB);
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_JOB_MYJOB);
    ...
    public static MyJobsFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
        MyJobsFragment frag = new MyJobsFragment();
        frag.parent = parent;
    ...
    public static MyJobsFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);

    }

    public static MyJobsFragment newInstance(int categoryId) {
