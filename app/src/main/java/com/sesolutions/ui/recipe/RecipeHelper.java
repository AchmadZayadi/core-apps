...
public class RecipeHelper extends SpeakableContent {
    ...
    private void goToNextScreen(BlogAdapter.ContactHolder holder) {
        ...
        try {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .replace(R.id.container, ViewRecipeFragment.newInstance(videoList.get(position).getRecipeId(), bundle)).addToBackStack(null).commit();
        } catch (Exception e) {
            CustomLog.e(e);
            fragmentManager.beginTransaction()
                    .replace(R.id.container
                            , ViewRecipeFragment.newInstance(videoList.get(position).getRecipeId()))
                    .addToBackStack(null)
                    .commit();
        }
