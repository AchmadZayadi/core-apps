...
public class RecipeParentFragment extends BaseFragment implements View.OnClickListener, OnUserClickedListener<Integer, Object> {
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(RecipeFragment.newInstance(this, 0), getStrings(R.string.TAB_TITLE_RECIPE_1));
        adapter.addFragment(RecipeCategoriesFragment.newInstance(this), getStrings(R.string.TAB_TITLE_RECIPE_2));
        if (SPref.getInstance().isLoggedIn(context)) {
            adapter.addFragment(RecipeFragment.newInstance(this, SPref.getInstance().getInt(context, Constant.KEY_LOGGED_IN_ID)), getStrings(R.string.TAB_TITLE_RECIPE_3));
            adapter.addFragment(
    ...
    private void goToSearchRecipeFragment() {
        fragmentManager.beginTransaction().replace(R.id.container, new SearchRecipeFragment()).addToBackStack(null).commit();
    }
