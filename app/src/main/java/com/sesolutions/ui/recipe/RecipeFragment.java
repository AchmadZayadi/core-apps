...
public class RecipeFragment extends RecipeHelper implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static RecipeFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
    ...
    public static RecipeFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);

    }

    public static RecipeFragment newInstance(int categoryId) {
