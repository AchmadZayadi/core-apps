...
public class RecipeCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String>, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View v;
    public RecipeParentFragment parent;
    ...
    public static RecipeCategoriesFragment newInstance(RecipeParentFragment parent) {
        RecipeCategoriesFragment frag = new RecipeCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewRecipeCategoryFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
}
