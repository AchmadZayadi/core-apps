...
public class ViewNewsFragment extends NewsHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        init();
        callMusicAlbumApi(1);
        callBottomCommentLikeApi(albumId, Constant.ResourceType.NEWS, Constant.URL_VIEW_COMMENT_LIKE);
        if (openComment) {
            //change value of openComment otherwise it prevents coming back from next screen
            openComment = false;
            goToCommentFragment(albumId, Constant.ResourceType.NEWS);
        }
        return v;
    }
...
//            collapsingToolbar.setTitle(album.getTitle());
            ...
            Util.showImageWithGlide(ivCoverPhoto, album.getNewsImages().getMain(), context/*, R.drawable.placeholder_square*/);
   ...
   /* private void unfilledAllStar() {
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put(Constant.KEY_NEWS_ID, album.getNewsId());
                    request.params.put(Constant.KEY_RESOURCE_ID, album.getNewsId());
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.BASE_URL + "news/" + albumId + Constant.POST_URL);
                    request.params.put(Constant.KEY_LIMIT, Constant.RECYCLE_ITEM_THRESHOLD);
             /*       if (!TextUtils.isEmpty(searchKey))
                        request.params.put(Constant.KEY_SEARCH, searchKey);*/
                    // request.params.put("news", albumId);
    ...
    public static ViewNewsFragment newInstance(int albumId, boolean comment) {
        ViewNewsFragment frag = new ViewNewsFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewNewsFragment newInstance(int albumId, Bundle bundle) {
        ViewNewsFragment frag = new ViewNewsFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewNewsFragment newInstance(int albumId) {
        return ViewNewsFragment.newInstance(albumId, false);
    }
   ...
   /* public void loadMore() {
        ...
        try {
            ...
            switch (opt.getName()) {
                case Constant.OptionType.EDIT:
                    goToFormFragment(album.getNewsId());
                    break;
                case Constant.OptionType.DELETE:
                    showDeleteDialog(VIEW_NEWS_DELETE, albumId, 0);
                    break;
                ...
                case Constant.OptionType.UPLOAD_PHOTO:
                    gToAlbumImage(Constant.URL_EDIT_NEWS_PHOTO, album.getNewsImages().getMain(), Constant.TITLE_EDIT_NEWS_PHOTO);
                    break;
    ...
    public void onStart() {
        ...
        } else if (activity.taskPerformed == Constant.FormType.TYPE_NEWS_EDIT) {
            activity.taskPerformed = 0;
            callMusicAlbumApi(1);
        }
    ...
    private void goToReportFragment() {
        String guid = album.getResourceType() + "_" + album.getNewsId();
    ...
    private void gToAlbumImage(String url, String main, String title) {
        ...
        map.put(Constant.KEY_NEWS_ID, album.getNewsId());
