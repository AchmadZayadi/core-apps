...
public class NewsCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String> {
    ...
    public View v;
    public NewsParentFragment parent;
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_NEWS_CATEGORIES_BROWSE);
    ...
    public static NewsCategoriesFragment newInstance(NewsParentFragment parent) {
        NewsCategoriesFragment frag = new NewsCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewNewsCategoryFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
}
