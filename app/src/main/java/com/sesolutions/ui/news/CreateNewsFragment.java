...
public class CreateNewsFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
...
/*    private RecyclerView mRecyclerView;
    ...
    public static CreateNewsFragment newinstance(int formType, String url, OnUserClickedListener<Integer, Object> listener) {
        CreateNewsFragment frag = new CreateNewsFragment();
        frag.url = url;
   ...
   /* private void setTitle() {
    ...
    public static CreateNewsFragment newInstance(int type, Map<String, Object> map, String url) {
