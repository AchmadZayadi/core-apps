...
public class RSSNewsAdapter extends RecyclerView.Adapter<RSSNewsAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(RSSNewsAdapter.ContactHolder holder) {
    ...
    public RSSNewsAdapter(List<News> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            final News vo = list.get(position);
