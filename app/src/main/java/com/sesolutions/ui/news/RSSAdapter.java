...
public class RSSAdapter extends RecyclerView.Adapter<RSSAdapter.ContactHolder> {


    private final List<RSS> list;
    ...
    @Override
    public void onViewAttachedToWindow(RSSAdapter.ContactHolder holder) {
    ...
    public RSSAdapter(List<RSS> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            final RSS vo = list.get(position);
