...
public class BrowseNewsListFragment extends NewsHelper implements View.OnClickListener, OnLoadMoreListener {
    ...
    public int userId;
    private String txtNoMsg = Constant.MSG_NO_NEWS;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        txtNoMsg = loggedinId > 0 ? Constant.MSG_NO_NEWS_CREATED_YOU : Constant.MSG_NO_NEWS_CREATED;
        return v;
    }
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new NewsAdapter(videoList, context, this, this, loggedinId > 0 ? Constant.FormType.TYPE_MY_ALBUMS : Constant.FormType.TYPE_MUSIC_ALBUM);
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_NEWS_BROWSE);
    ...
    public static BrowseNewsListFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
        BrowseNewsListFragment frag = new BrowseNewsListFragment();
        frag.parent = parent;
    ...
    public static BrowseNewsListFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);

    }

    public static BrowseNewsListFragment newInstance(int categoryId) {
