...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(NewsAdapter.ContactHolder holder) {
    ...
    public NewsAdapter(List<News> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
