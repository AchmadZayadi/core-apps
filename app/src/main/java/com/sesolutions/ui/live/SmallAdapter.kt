...
class SmallAdapter(private val mContext: Context, users: ArrayList<UserInfo>) : androidx.recyclerview.widget.RecyclerView.Adapter<SmallAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val size = getScreenWidth(mContext) / 5
        val padding = dpToPx(mContext, 8)

        mvg.layoutParams.width = size
        mvg.layoutParams.height = size * 2 / 3
    ...
    inner class ViewHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        ...
        init {
            root.layoutParams = androidx.recyclerview.widget.RecyclerView.LayoutParams(androidx.recyclerview.widget.RecyclerView.LayoutParams.MATCH_PARENT, androidx.recyclerview.widget.RecyclerView.LayoutParams.MATCH_PARENT)
        }
    }
