...
public class SuggestionPageAdapter extends RecyclerView.Adapter<SuggestionPageAdapter.ContactHolder> {
    ...
    public SuggestionPageAdapter(List<PageContent> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, boolean isRecent) {
        this.list = list;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            final PageContent vo = list.get(position);
