...
public class PageMapFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object> {
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != resp.getResult().getLocations())
                                            friendList.addAll(resp.getResult().getLocations());
                                    } else {
  ...
  /*  public static GroupMemberFragment newInstance(int resourceId) {
    ...
    public static PageMapFragment newInstance(Bundle bundle) {
        PageMapFragment frag = new PageMapFragment();
        frag.bundle = bundle;
        return frag;
    }
    ...
    public static PageMapFragment newInstance(Bundle bundle,boolean istoolbar) {
        PageMapFragment frag = new PageMapFragment();
        frag.bundle = bundle;
