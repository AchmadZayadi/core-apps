...
public class InviteFormFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditPageFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static InviteFormFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        InviteFormFragment fragment = new InviteFormFragment();
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(R.string.invite));
  ...
  /*  @Override
    public void onValueChanged(BaseFormElement baseFormElement) {
        ...
        try {
            if (BaseFormElement.TYPE_PICKER_MULTI == baseFormElement.getType()) {
                if (((FormElementPickerSingle) baseFormElement).getName().equals("sespage_choose_all")) {
