...
public class CreateEditPageFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditPageFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateEditPageFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateEditPageFragment fragment = new CreateEditPageFragment();
    ...
    public static CreateEditPageFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result, Boolean showToolbar) {
        CreateEditPageFragment fragment = new CreateEditPageFragment();
        fragment.FORM_TYPE = type;
        fragment.url = url;
        fragment.map = map;
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.CREATE_PAGE ? R.string.title_create_page : R.string.title_edit_page));
