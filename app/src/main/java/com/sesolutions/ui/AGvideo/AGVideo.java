...
import com.sesolutions.ui.AGvideo.view.LoadingView;
import com.sesolutions.ui.AGvideo.view.PlayAndPauseView;
...
public class AGVideo extends JzvdStd {
    ...
    public void init(Context context) {
        ...
        viewfullid = findViewById(R.id.viewfullid);
...
//                        mDownY = y;
    ...
    public void setScreenFullscreen() {
        ...
        viewfullid.setVisibility(VISIBLE);
...
//        super.onStatePlaying();
    ...
    public boolean isHaveNetWork() {
        if (!NetworkUtils.isNetworkAvailable(this.getApplicationContext()) || !NetworkUtils.isNetworkAvailable(this.getApplicationContext())) {
            return false;
        }
        return true;
    }
