...
public class SearchCEventFragment extends CEventFragment implements View.OnClickListener {
   ...
   // private int isBackFrom;
    ...
    public static SearchCEventFragment newInstance(String selectedScreen) {
        SearchCEventFragment frag = new SearchCEventFragment();
    ...
    public void init() {
        ...
        switch (selectedScreen) {
            ...
            default:
                ...
                filterUrl = Constant.URL_FILTER_CEVENT;
