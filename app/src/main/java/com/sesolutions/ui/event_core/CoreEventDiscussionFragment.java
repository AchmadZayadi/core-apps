...
public class CoreEventDiscussionFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object>/*, SwipeRefreshLayout.OnRefreshListener*/ {
    ...
    public static CoreEventDiscussionFragment newInstance(Map<String, Object> map) {
        CoreEventDiscussionFragment frag = new CoreEventDiscussionFragment();
        frag.map = map;
        return frag;
    }
        ...
        try {
            switch (v.getId()) {
                ...
                case R.id.cvPost:
                    ...
                    super.openFormFragment(Constant.FormType.CREATE_DISCUSSTION, map, Constant.URL_CREATE_CORE_EVENT_DISCUSSION);
                    break;
            }
        } catch (Exception e) {
            CustomLog.e(e);
    ...
    private void showHideUpperLayout() {
        if (null != result.getPostButton()) {
            ...
            v.findViewById(R.id.cvPost).setBackgroundColor(Color.parseColor(Constant.text_color_1));
            ((TextView)v.findViewById(R.id.tvPost)).setTextColor(Color.parseColor(Constant.backgroundColor));
            ((ImageView)v.findViewById(R.id.ivPost)).setColorFilter(Color.parseColor(Constant.backgroundColor));
    ...
    public boolean onItemClicked(Integer object1, Object object2, int postion) {
        switch (object1) {
            ...
            case Constant.Events.MUSIC_MAIN:
                fragmentManager.beginTransaction().replace(R.id.container, CoreEventDiscussionView.newInstance(categoryList.get(postion).getTopicId())).addToBackStack(null).commit();
                break;
