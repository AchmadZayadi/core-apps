 ...
 */
public class ViewCEventFragment extends CommentLikeHelper implements PopupMenu.OnMenuItemClickListener, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, TabLayout.OnTabSelectedListener, OnUserClickedListener<Integer, Object> {
   ...
   //View viewitem;
    ...
    public static ViewCEventFragment newInstance(int groupId) {
        ViewCEventFragment frag = new ViewCEventFragment();
    ...
    private void updateProfilePhoto(String url) {
        Util.showImageWithGlide((ImageView) v.findViewById(R.id.ivPageImage), url, context, R.drawable.default_user);
    }
/*
    @Override
    public void onStop() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_event2, container, false);
        applyTheme(v);
     //   viewitem = v.findViewById(R.id.viewitem);
        ...
        callMusicAlbumApi(1);
    //    viewitem.setBackgroundColor(Color.parseColor(Constant.text_color_1));
    ...
    private void initCollapsingToolbar() {
        ...
        collapsingToolbar.setBackgroundColor(Color.parseColor(Constant.backgroundColor));
    ...
    public String getDetail(CommonVO album) {
        String detail = "";
        try {
            detail += Constant.FontIcon.LIKE+" "+album.getLikeCount()
                    + "  " +Constant.FontIcon.COMMENTs+" "+ album.getCommentCount()
                    + "  " +Constant.FontIcon.VIEWS+" "+ album.getViewCountInt()
                    // + ", " + album.getFavouriteCount() + (album.getFavouriteCount() != 1 ? getString(R.string._FAVORITES) : getString(R.string._FAVORITE))
                    + "  " +Constant.FontIcon.FOLLOWERS+" "+ album.getFollowCount()
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        for(int i=0;i<menu.size();i++){
            ...
            tintMenuItemIcon(Color.WHITE, item);
        }
        ...
        try {
            ...
            progressDialog.findViewById(R.id.bCamera).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new ApiController(url, map, context, ViewCEventFragment.this, Constant.Events.REMOVE_PHOTO).execute();
    ...
    private int getTabPositionByName(String name) {
        ...
        for (int i = 0; i < result.getEventContent().getProfileTabs().size(); i++) {
            if (result.getEventContent().getProfileTabs().get(i).getName().equals(name)) {
                position = i;
                break;
            }
        }
        ...
        try {
            ...
            switch (object1) {
                ...
                case Constant.Events.PAGE_SUGGESTION_MAIN:
                    ...
                    goToViewCEventFragment(position);
                    break;
