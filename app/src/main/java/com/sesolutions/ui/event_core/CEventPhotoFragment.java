...
/*    public List<Albums> videoList;
    ...
    public static CEventPhotoFragment newInstance(OnUserClickedListener<Integer, Object> parent, int mEventId, String selectedScreen) {
        CEventPhotoFragment frag = new CEventPhotoFragment();
        frag.listener = parent;
        frag.selectedScreen = selectedScreen;
        frag.mEventId = mEventId;
        frag.loggedinId = -1;
        frag.categoryId = -1;
        return frag;
                ...
                case R.id.cvPost:
                    ...
                    fragmentManager.beginTransaction()
                            .replace(R.id.container, UploadPhotoFragment.newInstance(map,
                                    Constant.URL_CEVENT_PHOTO_UPLOAD, getString(R.string.TITLE_UPLOAD_PHOTOS)))
                            .addToBackStack(null)
                            .commit();
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_CEVENT_PHOTO);
    ...
    public boolean onItemClicked(Integer object1, Object screenType, int postion) {
        ...
        switch (object1) {
            ...
            case Constant.Events.MUSIC_MAIN:
                ...
                map.put(Constant.KEY_RESOURCES_TYPE, Constant.ResourceType.EVENT_PHOTO);
