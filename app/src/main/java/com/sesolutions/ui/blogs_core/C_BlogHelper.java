...
public class C_BlogHelper extends SpeakableContent_basic {
    ...
    public boolean onItemClicked(Integer object1, Object screenType, int postion) {
        ...
        switch (object1) {
            ...
            case Constant.Events.MUSIC_MAIN:
                goToNextScreen((C_BlogAdapter.ContactHolder) screenType);
                break;
    ...
    public void showDeleteDialog(final int REQ, final int blogId, final int position) {
        try {
            ...
            tvMsg.setText(R.string.MSG_DELETE_CONFIRMATION_BLOG);
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.URL_DELETE_BLOG);
    ...
    public void goToFormFragment(int blogId) {
        ...
        fragmentManager.beginTransaction().replace(R.id.container, FormFragment.newInstance(Constant.FormType.TYPE_BLOG_EDIT, map, Constant.URL_EDIT_BLOG)).addToBackStack(null).commit();
    }


    private void goToNextScreen(C_BlogAdapter.ContactHolder holder) {
        ...
        try {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .replace(R.id.container, C_ViewBlogFragment.newInstance(videoList.get(position).getBlogId(), bundle)).addToBackStack(null).commit();
        } catch (Exception e) {
            CustomLog.e(e);
            fragmentManager.beginTransaction()
                    .replace(R.id.container
                            , C_ViewBlogFragment.newInstance(videoList.get(position).getBlogId()))
                    .addToBackStack(null)
                    .commit();
        }
