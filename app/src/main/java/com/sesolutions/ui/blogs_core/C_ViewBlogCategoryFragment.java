...
public class C_ViewBlogCategoryFragment extends BrowseBlogsFragment implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static C_ViewBlogCategoryFragment newInstance(int categoryId, String categoryName) {
        C_ViewBlogCategoryFragment frag = new C_ViewBlogCategoryFragment();
        frag.parent = null;
