...
public class C_ViewBlogFragment extends C_BlogHelper implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_blog_basic, container, false);
        applyTheme(v);
        init();
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
    ...
    public static C_ViewBlogFragment newInstance(int albumId, boolean comment) {
        C_ViewBlogFragment frag = new C_ViewBlogFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static C_ViewBlogFragment newInstance(int albumId, Bundle bundle) {
        C_ViewBlogFragment frag = new C_ViewBlogFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static C_ViewBlogFragment newInstance(int albumId) {
        return C_ViewBlogFragment.newInstance(albumId, false);
    }
