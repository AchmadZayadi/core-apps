...
public class ContestCategoryAdapter extends RecyclerView.Adapter<ContestCategoryAdapter.ContactHolder> {
   ...
   /* @Override
    ...
    public ContestCategoryAdapter(List<CategoryPage> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr) {
        this.list = list;
        this.listCat = null;
        this.context = cntxt;
    ...
    public ContestCategoryAdapter(List<Category> list, OnUserClickedListener<Integer, Object> listenr, Context context) {
        this.listCat = list;
        this.list = null;
