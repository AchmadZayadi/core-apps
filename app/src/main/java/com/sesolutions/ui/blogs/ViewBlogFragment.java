...
public class ViewBlogFragment extends BlogHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {

    private static final int UPDATE_UPPER_LAYOUT = 101;
    public static final int CAMERA_PIC_REQUEST = 7080;
    private boolean isLoading;
    private int REQ_LOAD_MORE = 2;
    private CommonResponse2.Result result;
    private Blog album;
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    HttpRequestVO request = new HttpRequestVO(Constant.BASE_URL + "blog/" + albumId + Constant.POST_URL);
    ...
    public static ViewBlogFragment newInstance(int albumId, boolean comment) {
        ViewBlogFragment frag = new ViewBlogFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewBlogFragment newInstance(int albumId, Bundle bundle) {
        ViewBlogFragment frag = new ViewBlogFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewBlogFragment newInstance(int albumId) {
        return ViewBlogFragment.newInstance(albumId, false);
    }
   ...
   /* public void loadMore() {
    ...
    private void gToAlbumImage(String url, String main, String title) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, AlbumImageFragment.newInstance(title, url, main, map,true,1001))
                .addToBackStack(null)
                .commit();
    }
