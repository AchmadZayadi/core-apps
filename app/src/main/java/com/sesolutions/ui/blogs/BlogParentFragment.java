...
public class BlogParentFragment extends BaseFragment implements View.OnClickListener, OnUserClickedListener<Integer, Object> {
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(BrowseBlogsFragment.newInstance(this, 0), getStrings(R.string.TAB_TITLE_BLOG_1));
        ...
        if (SPref.getInstance().isLoggedIn(context)) {
            adapter.addFragment(BrowseBlogsFragment.newInstance(this, SPref.getInstance().getInt(context, Constant.KEY_LOGGED_IN_ID)), getStrings(R.string.TAB_TITLE_BLOG_3));
            if(!SPref.getInstance().isBasicPlugins(context,"blog")){
                adapter.addFragment(
