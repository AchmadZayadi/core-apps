...
public class BlogHelper extends SpeakableContent {
    ...
    private void goToNextScreen(BlogAdapter.ContactHolder holder) {
        ...
        try {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .replace(R.id.container, ViewBlogFragment.newInstance(videoList.get(position).getBlogId(), bundle)).addToBackStack(null).commit();
        } catch (Exception e) {
            CustomLog.e(e);
            fragmentManager.beginTransaction()
                    .replace(R.id.container
                            , ViewBlogFragment.newInstance(videoList.get(position).getBlogId()))
                    .addToBackStack(null)
                    .commit();
        }
