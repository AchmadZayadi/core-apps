...
public class BlogCategoriesFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String> {
    ...
    public static BlogCategoriesFragment newInstance(BlogParentFragment parent) {
        BlogCategoriesFragment frag = new BlogCategoriesFragment();
        frag.parent = parent;
        return frag;
    }
