...
public class BlogAdapter extends RecyclerView.Adapter<BlogAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(BlogAdapter.ContactHolder holder) {
    ...
    public BlogAdapter(List<Blog> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
