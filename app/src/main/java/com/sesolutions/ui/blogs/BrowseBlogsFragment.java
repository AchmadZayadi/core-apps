...
public class BrowseBlogsFragment extends BlogHelper implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static BrowseBlogsFragment newInstance(int userId, boolean showToolbar) {
        BrowseBlogsFragment frag = new BrowseBlogsFragment();
    ...
    public static BrowseBlogsFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
        BrowseBlogsFragment frag = new BrowseBlogsFragment();
        frag.parent = parent;
    ...
    public static BrowseBlogsFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);

    }

    public static BrowseBlogsFragment newInstance(int categoryId) {
