...
public class CreateEditReview extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditPageFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateEditReview newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateEditReview fragment = new CreateEditReview();
    ...
    public static CreateEditReview newInstance(int type, Map<String, Object> map, String url, Dummy.Result result, Boolean showToolbar) {
        CreateEditReview fragment = new CreateEditReview();
        fragment.FORM_TYPE = type;
        fragment.url = url;
        fragment.map = map;
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.CREATE_PAGE ? R.string.title_create_page : R.string.title_editService));
