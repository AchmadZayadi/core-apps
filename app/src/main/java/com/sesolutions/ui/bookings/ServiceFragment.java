...
public class ServiceFragment extends BookingHelper<ServiceAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ServiceFragment newInstance(BookingParentFragment parent, int loggedInId, int categoryId) {
    ...
    public static ServiceFragment newInstance(BookingParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }

    public static ServiceFragment newInstance(String TYPE, BookingParentFragment parent) {
        ServiceFragment frag = newInstance(parent, -1, -1);
        frag.selectedScreen = TYPE;
        return frag;
    }

    public static ServiceFragment newInstance(String TYPE, int businessId) {
        ServiceFragment frag = newInstance(null, -1, -1);
        frag.selectedScreen = TYPE;
    ...
    public static ServiceFragment newInstance(int categoryId) {
    ...
    public void init() {
        ...
        switch (selectedScreen) {
            ...
            case "profile_services":
                ...
                break;
            case "services":
                url = Constant.URL_SERVICE_BROWSE;
                break;
