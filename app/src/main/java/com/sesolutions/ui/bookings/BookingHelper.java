...
public class BookingHelper<T extends RecyclerView.Adapter> extends CommentLikeHelper implements View.OnClickListener {
    ...
    public List<ProfessionalVo> videoList;
    public T adapter;
    public List<Category> categoryList;
    public ProfessionalResponse.Result result;
        ...
        try {
            switch (object1) {
                ...
                case Constant.Events.MUSIC_MAIN:
                    ...
                    break;
                case Constant.Events.VIEW_SERVICE:
                    openViewServiceFragment(videoList.get(postion).getService().getservice_id());
                    break;
                case Constant.Events.VIEW_PROFESSIONAL:
                    openViewProfessionalPage(videoList.get(postion).getProfessional().getProfessional_id());
                    break;
                ...
                case Constant.Events.CATEGORY:
                    ...
                    break;
                case Constant.Events.OPEN_WEB:
                    openWebView(videoList.get(postion).getService().getBookUrl()+ "?removeSiteHeaderFooter=true", "Book");
                    break;
                case Constant.Events.OPEN_PRO_BOOK:
                    openWebView(videoList.get(postion).getProfessional().getBookUrl() + "?removeSiteHeaderFooter=true", "Book");
                    break;
