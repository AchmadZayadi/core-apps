...
public class ProfessionalFragment extends BookingHelper<ProfessionalAdapter> implements OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static ProfessionalFragment newInstance(BookingParentFragment parent, int loggedInId, int categoryId) {
        ProfessionalFragment frag = new ProfessionalFragment();
        frag.parent = parent;
    ...
    public static ProfessionalFragment newInstance(BookingParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }

    public static ProfessionalFragment newInstance(String TYPE, BookingParentFragment parent) {
        ProfessionalFragment frag = newInstance(parent, -1, -1);
        frag.selectedScreen = TYPE;
        return frag;
    }

    public static ProfessionalFragment newInstance(String TYPE, int businessId) {
        ProfessionalFragment frag = newInstance(null, -1, -1);
        frag.selectedScreen = TYPE;
    ...
    public static ProfessionalFragment newInstance(int categoryId) {
    ...
    public void init() {
        ...
        txtNoData = R.string.MSG_NO_PROFESSIONAL_FOUND;
                        ...
                        if (response != null) {
                            ...
                            if (TextUtils.isEmpty(err.getError())) {
                                ...
                                if (null != result.getProfessionals()) {
                                    videoList.addAll(result.getProfessionals(selectedScreen));
                                }
                                updateAdapter();
                            } else {
    ...
    public void updateAdapter() {
        ...
        if (parent != null) {
            parent.onItemClicked(Constant.Events.UPDATE_TYPE, selectedScreen, result.getTotal());
        }
    }
