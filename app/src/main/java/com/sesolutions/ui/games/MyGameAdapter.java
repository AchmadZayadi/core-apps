...
public class MyGameAdapter extends RecyclerView.Adapter<MyGameAdapter.ContactHolder> {
   ...
   /* private final Drawable dLike;
    ...
    public MyGameAdapter(List<Albums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
