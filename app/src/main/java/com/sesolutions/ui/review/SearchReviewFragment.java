...
import com.sesolutions.ui.page.PageReviewFragment;
...
public class SearchReviewFragment extends PageReviewFragment implements View.OnClickListener, OnLoadMoreListener {


    private AppCompatEditText etMusicSearch;
    private int isBackFrom;

    public static SearchReviewFragment newInstance(String selectedScreen) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        getMapValues();
        init();
        //txtNoData = R.string.msg_no_review;
        setRecyclerView();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SERACH_REVIEW);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_PAGE_REVIEW, map, Constant.URL_PAGE_REVIEW_FILTER))
                .addToBackStack(null)
                .commit();
    }
