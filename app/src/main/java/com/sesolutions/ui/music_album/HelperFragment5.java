...
public class HelperFragment5 extends CommentLikeHelper {
    public MusicParentFragment parent;
    public List<Albums> albumsList;
    public MusicAlbumAdapter3 adapter;
        ...
        try {
            switch (object1) {
                ...
                case Constant.Events.MUSIC_MAIN:
                    goToNextScreen(postion, (MusicAlbumAdapter3.ContactHolder) screenType);
                    break;
            }
        ...
        try {
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put("resource_type", "sesmusic_album");
                    if(issave){
    ...
    private void goToNextScreen(int screenType, MusicAlbumAdapter3.ContactHolder holder) {
    ...
    private void goToViewMusicAlbumFragment(int position, MusicAlbumAdapter3.ContactHolder holder, Bundle bundle) {
    ...
    private void goToViewPlaylistFragment(int postion, MusicAlbumAdapter3.ContactHolder holder, Bundle bundle) {
        try {
            fragmentManager.beginTransaction()
                    .addSharedElement(holder.ivSongImage, ViewCompat.getTransitionName(holder.ivSongImage))
    ...
    private void goToViewArtistFragment(int postion, MusicAlbumAdapter3.ContactHolder holder, Bundle bundle) {
        try {
            fragmentManager.beginTransaction()
                    .addSharedElement(holder.ivSongImage, ViewCompat.getTransitionName(holder.ivSongImage))
                    .addSharedElement(holder.ivFavorite, ViewCompat.getTransitionName(holder.ivFavorite))
    ...
    private void goToSongsView(Map<String, Object> map, int songId, String resourceType, MusicAlbumAdapter3.ContactHolder holder, Bundle bundle) {
    ...
    public void callLikeApi(final int REQ_CODE, final int screenType, final int position, String url, final Albums vo) {
        try {
            if (isNetworkAvailable(context)) {
                try {
                    HttpRequestVO request = new HttpRequestVO(url);
