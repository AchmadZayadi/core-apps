...
public class AlbumImageFragment extends BaseFragment implements View.OnClickListener, MyMultiPartEntity.ProgressListener {
...
//                    showDialog(Constant.MSG_SELECT_IMAGE_SOURCE);
    ...
    public void setImage(String path) {
      ...
      /*  UCrop uCrop = UCrop.of(Uri.fromFile(file), Uri.fromFile(file));
        ...
        uCrop.withMaxResultSize(720,1027);
        uCrop.start(getActivity(), AlbumImageFragment.this);
*/
        Uri destination = Uri.fromFile(new File(getActivity().getCacheDir(), "cropped"));
        Crop.of(Uri.fromFile(file), destination).asSquare().start(context,AlbumImageFragment.this);
    ...
    public static AlbumImageFragment newInstance(String title, String url, String imageUrl, Map<String, Object> map) {
        AlbumImageFragment frag = new AlbumImageFragment();
        frag.title = title;
        frag.url = url;
    ...
    public static AlbumImageFragment newInstance(String title, String url, String imageUrl, Map<String, Object> map,boolean flagdata ) {
        AlbumImageFragment frag = new AlbumImageFragment();
        frag.title = title;
        frag.url = url;
        frag.imageUrl = imageUrl;
    ...
    public static AlbumImageFragment newInstance(String title, String url, String imageUrl, Map<String, Object> map,boolean flagdata,int albumflag ) {
        AlbumImageFragment frag = new AlbumImageFragment();
        frag.title = title;
        frag.url = url;
        frag.imageUrl = imageUrl;
