...
public class MusicLyricsAdapter extends RecyclerView.Adapter<MusicLyricsAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull MusicLyricsAdapter.ContactHolder holder) {
    ...
    public MusicLyricsAdapter(List<Albums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE)
    {
        this.list = list;
        this.context = cntxt;
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_music_lyrics, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            holder.llArtist.setVisibility(SCREEN_TYPE == Constant.FormType.TYPE_LYRICS ? View.VISIBLE : View.VISIBLE);
            ...
            try {
                holder.videocountid.setText(""+vo.getSongCount());
            }catch (Exception ex){
                ex.printStackTrace();
            }
