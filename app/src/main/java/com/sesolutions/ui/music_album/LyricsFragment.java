...
public class LyricsFragment extends HelperFragment4 implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new MusicLyricsAdapter(albumsList, context, this, this, Constant.FormType.TYPE_LYRICS);
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put(Constant.KEY_LYRICS, true);
    ...
    private void updateAdapter() {
        ...
        if (parent != null) {
            parent.updateTotal(4, result.getTotal());
        }
        ((TextView) v.findViewById(R.id.tvNoData)).setText(R.string.MSG_NO_SONG_AVAILABLE);
        v.findViewById(R.id.llNoData).setVisibility(albumsList.size() > 0 ? View.GONE : View.VISIBLE);
    }

    public static LyricsFragment newInstance(MusicParentFragment parent) {
