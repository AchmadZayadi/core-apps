...
public class MusicAlbumAdapter extends RecyclerView.Adapter<MusicAlbumAdapter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(@NonNull MusicAlbumAdapter.ContactHolder holder) {
    ...
    public MusicAlbumAdapter(List<Albums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE)
    {
        this.list = list;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            if(SCREEN_TYPE==Constant.FormType.TYPE_MUSIC_ALBUM || SCREEN_TYPE==Constant.FormType.TYPE_PLAYLIST){
