...
public class HelperFragment extends CommentLikeHelper {
        ...
        try {
            switch (object1) {
                ...
                case Constant.Events.MUSIC_MAIN:
                    goToNextScreen(postion, (MusicAlbumAdapter.ContactHolder) screenType);
                    break;
            }
    ...
    private void goToNextScreen(int screenType, MusicAlbumAdapter.ContactHolder holder) {
    ...
    private void goToViewMusicAlbumFragment(int position, MusicAlbumAdapter.ContactHolder holder, Bundle bundle) {
    ...
    private void goToViewPlaylistFragment(int postion, MusicAlbumAdapter.ContactHolder holder, Bundle bundle) {
        try {
            fragmentManager.beginTransaction()
                    .addSharedElement(holder.ivSongImage, ViewCompat.getTransitionName(holder.ivSongImage))
    ...
    private void goToViewArtistFragment(int postion, MusicAlbumAdapter.ContactHolder holder, Bundle bundle) {
        try {
            fragmentManager.beginTransaction()
                    .addSharedElement(holder.ivSongImage, ViewCompat.getTransitionName(holder.ivSongImage))
                    .addSharedElement(holder.ivFavorite, ViewCompat.getTransitionName(holder.ivFavorite))
    ...
    private void goToSongsView(Map<String, Object> map, int songId, String resourceType, MusicAlbumAdapter.ContactHolder holder, Bundle bundle) {
