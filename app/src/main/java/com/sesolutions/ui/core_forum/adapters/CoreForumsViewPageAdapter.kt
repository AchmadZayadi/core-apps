...
class CoreForumsViewPageAdapter(private val list: List<ForumResponse2.Topic>,
                   private val context: Context,
                   private val listener: OnUserClickedListener<Int, Any>,
                   private val loadListener: OnLoadMoreListener) : androidx.recyclerview.widget.RecyclerView.Adapter<CoreForumsViewPageAdapter.CategoryHolder>() {
...
//                parentHolder.ivSticky.visibility = View.GONE
            ...
            Util.showImageWithGlide(parentHolder.ivImage, vo.owneImages!!.main!!, context, R.drawable.placeholder_square)
