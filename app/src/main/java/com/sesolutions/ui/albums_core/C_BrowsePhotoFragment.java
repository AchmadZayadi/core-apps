...
import com.sesolutions.ui.albums.PhotoHelper;
...
public class C_BrowsePhotoFragment extends C_PhotoHelper implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
...
/*    public List<Albums> videoList;
    ...
    LinearLayoutCompat mainlllenaer102;

    public static C_BrowsePhotoFragment newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        C_BrowsePhotoFragment frag = new C_BrowsePhotoFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_browse_photo2, container, false);
    ...
    public void init() {
        ...
        mainlllenaer102 = v.findViewById(R.id.mainlllenaer102);

    }

    private void updateHeaderView() {

        ImageView ivImage11 = v.findViewById(R.id.ivImage11);
        ImageView ivImage12 = v.findViewById(R.id.ivImage12);
        ImageView ivImage13 = v.findViewById(R.id.ivImage13);
        ImageView ivImage14 = v.findViewById(R.id.ivImage14);

        if (staggeredAlbums.getFirstAlbum() != null) {
            Util.showImageWithGlide(ivImage11, staggeredAlbums.getFirstAlbum().getImages().getMain(), context, R.drawable.placeholder_square);
            ivImage11.setVisibility(View.VISIBLE);
            ivImage11.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            ivImage11.setVisibility(View.GONE);
        }

        if (staggeredAlbums.getSecondAlbum() != null) {
            Util.showImageWithGlide(ivImage12, staggeredAlbums.getSecondAlbum().getImages().getMain(), context, R.drawable.placeholder_square);
            ivImage12.setVisibility(View.VISIBLE);
            ivImage12.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            ivImage12.setVisibility(View.GONE);
        }

        if (staggeredAlbums.getThirdAlbum() != null) {
            Util.showImageWithGlide(ivImage13, staggeredAlbums.getThirdAlbum().getImages().getMain(), context, R.drawable.placeholder_square);
            ivImage13.setVisibility(View.VISIBLE);
            ivImage13.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            ivImage13.setVisibility(View.GONE);
        }

        if (staggeredAlbums.getFourthAlbum() != null) {
            Util.showImageWithGlide(ivImage14, staggeredAlbums.getFourthAlbum().getImages().getMain(), context, R.drawable.placeholder_square);
            ivImage14.setVisibility(View.VISIBLE);
            ivImage14.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            ivImage14.setVisibility(View.GONE);
        }
    }
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new C_AlbumPhotoAdapter(videoList, context, this, this, Constant.FormType.TYPE_PHOTO);
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        if (null != result.getHeaderPhotos()) {
                                            ...
                                            updateHeaderView();
                                            mainlllenaer102.setVisibility(View.VISIBLE);
                                        }else {
                                            mainlllenaer102.setVisibility(View.GONE);
                                        }
