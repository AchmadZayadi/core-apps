...
public class C_AlbumHelper extends CommentLikeHelper_basic {
    ...
    public void goToViewAlbumFragment(Object view, int position) {
        ...
        C_AlbumAdapter.ContactHolder holder = (C_AlbumAdapter.ContactHolder) view;
        try {
            ...
            fragmentManager.beginTransaction()
                    ...
                    .replace(R.id.container, C_ViewAlbumFragment.newInstance(videoList.get(position).getAlbumId(), bundle)).addToBackStack(null).commit();

        } catch (Exception e) {
            CustomLog.e(e);
            goToViewAlbumFragment2(videoList.get(position).getAlbumId(), false);
        }
