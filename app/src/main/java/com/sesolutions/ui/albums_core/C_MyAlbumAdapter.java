...
public class C_MyAlbumAdapter extends RecyclerView.Adapter<C_MyAlbumAdapter.ContactHolder> {
   ...
   /* private final Drawable dLike;
    ...
    @Override
    public void onViewAttachedToWindow(C_MyAlbumAdapter.ContactHolder holder) {
    ...
    public C_MyAlbumAdapter(List<Albums> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
