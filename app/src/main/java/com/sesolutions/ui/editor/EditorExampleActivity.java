package com.sesolutions.ui.editor;

/**
 * Created by AheadSoft on 19-03-2018.
 */
...
public class EditorExampleActivity extends BaseActivity implements EditorFragmentListener/*, EditorDragAndDropListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            setContentView(R.layout.fragment_html_editor);
            //   }
            /*else {
    ...
    public void onBackPressed() {
        ...
        if (fragment != null && fragment.isVisible()) {
            ((ImageSettingsDialogFragment) fragment).dismiss();
        } else {
            super.onBackPressed();
        }
    }
   ...
   /* @Override
    ...
    public void uploadDataToServer(String htmlData) {
        CustomLog.e("htmlData", htmlData);
        String datanew="";
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
             datanew=""+Html.fromHtml(htmlData, Html.FROM_HTML_MODE_LEGACY);
        }
        CustomLog.e("datanew", datanew);
        Intent resultIntent = new Intent();
        resultIntent.putExtra(Constant.TEXT, datanew);
        resultIntent.putExtra(Constant.TAG, getIntent().getIntExtra(Constant.TAG,0));
