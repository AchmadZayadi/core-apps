...
class GroupTopicAdapter(private val list: List<ForumResponse.Topic>,
                   private val context: Context,
                   private val listener: OnUserClickedListener<Int, Any>,
                   private val loadListener: OnLoadMoreListener) : androidx.recyclerview.widget.RecyclerView.Adapter<GroupTopicAdapter.CategoryHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryHolder {
        ...
        return CategoryHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_group_topic, parent, false))
    }
