...
public class SearchGroupPollFragment extends PollFragment implements View.OnClickListener, OnLoadMoreListener {
   ...
   /* public static SearchPageFragment newInstance(String screenType) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        applyTheme(v);
        init();
        txtNoData = R.string.MSG_NO_PAGEPOLL_FOUND;
        setRecyclerView();
    ...
    public void init() {
        ...
        etMusicSearch.setHint(R.string.TXT_SERACH_PAGESPoll);
    ...
    private void goToMusicSearchForm() {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container,
                        FormFragment.newInstance(Constant.FormType.FILTER_PAGE_POLL, map, Constant.URL_SEARCH_GROP_POLL))
                .addToBackStack(null)
                .commit();
    }
