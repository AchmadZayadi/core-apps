...
public class SuggestionGroupAdapter extends RecyclerView.Adapter<SuggestionGroupAdapter.ContactHolder> {

    private final List<GroupContent> list;
    ...
    public SuggestionGroupAdapter(List<GroupContent> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, boolean isRecent) {
        this.list = list;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            final GroupContent vo = list.get(position);
            ...
            holder.rlMain.setOnClickListener(v -> listener.onItemClicked(Constant.Events.PAGE_SUGGESTION_MAIN, "" + holder, vo.getGroup_id()));
