...
public class BrowseWishFragment extends WishHelper<QuoteAdapter> implements View.OnClickListener, OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {

    private String BROWSE_URL = Constant.URL_BROWSE_WISH;
    ...
    public static BrowseWishFragment newInstance(WishParentFragment parent, int loggedInId, int categoryId) {
        BrowseWishFragment frag = new BrowseWishFragment();
        frag.parent = parent;
    ...
    public static BrowseWishFragment newInstance(WishParentFragment parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }


    public static BrowseWishFragment newInstance(int categoryId) {
