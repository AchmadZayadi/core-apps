...
import cn.jzvd.JZMediaInterface2;
import cn.jzvd.Jzvd2;

/**
 * Created by MinhDV on 5/3/18.
 */
public class JZMediaExo2 extends JZMediaInterface2 implements Player.EventListener, VideoListener {
    private SimpleExoPlayer simpleExoPlayer;
    private Runnable callback;
    private String TAG = "JZMediaExo";
    private long previousSeek = 0;

    public JZMediaExo2(Jzvd2 jzvd) {
        super(jzvd);
    }
    ...
    public void release() {
        if (mMediaHandler != null && mMediaHandlerThread != null && simpleExoPlayer != null) {//不知道有没有妖孽
            ...
            JZMediaInterface2.SAVED_SURFACE = null;
