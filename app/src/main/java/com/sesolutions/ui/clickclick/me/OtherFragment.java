...
public class OtherFragment extends MeHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public CircleImageView ivAlbumImage;
    public int pos = 0;
    ...
    public AppCompatTextView ivHeart2;
    ...
    public static int followtag=5000;
    ...
    public static OtherFragment newInstance(boolean fromNotification, int ownerId) {
        OtherFragment fragment = new OtherFragment();
        fragment.fromNotification = fromNotification;
        fragment.channel_owner_id = ownerId;
        return fragment;
    }
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.tvfollowingcount:
                    ...
                    intent23.putExtra(Constant.KEY_ID, channel_owner_id);
                ...
                case R.id.tvfollowerscount:
                    ...
                    intent12.putExtra(Constant.KEY_ID, channel_owner_id);
        ...
        if (isNetworkAvailable(context)) {
            ...
            try {
             ...
             /*       if (!TextUtils.isEmpty(searchKey))
                ...
                request.params.put("channel_owner_id", ""+channel_owner_id);
...
//                                        updateAdapter();
                                        ...
                                        llAlbumImage.setVisibility(View.GONE);
                                        tvFollowers.setVisibility(View.GONE);
    ...
    public void RefreshUpperLayout() {
        ...
        if (result.getChannels().get(pos).getUserTitle() != null) {
       ...
       /* if (channelList.get(pos).getUser_follow_count() > 1 || channelList.get(pos).getUser_follow_count() == 0) {
        ...
        try {
            if(!result2.getUser_info().isIs_content_follow()){
                tvFollowbtn.setVisibility(channel_owner_id== SPref.getInstance().getUserMasterDetail(getActivity()).getUserId() ? View.GONE:View.VISIBLE);
    ...
    private void callFollowersApi(final int req, int channel) {
        ...
        if (isNetworkAvailable(context)) {
            isLoading = true;
            String URL_DATA= URL.URL_CHANNEL_FOLLOWERS2+""+channel_owner_id+""+POST_URL;
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                  ...
                  //      showView(v.findViewById(R.id.pbMain));
                    ...
                    request.params.put("user_id", channel_owner_id);
                    request.params.put(Constant.KEY_FROMTICVIDEO, "1");
                    request.headres.put(Constant.KEY_COOKIE, getCookie());
                    request.params.put(Constant.KEY_AUTH_TOKEN, SPref.getInstance().getToken(context));
        ...
        try {
            ...
            if (isNetworkAvailable(context)) {
                ...
                try {
                    ...
                    request.params.put(Constant.KEY_USER_ID, channel_owner_id);
                    request.headres.put(Constant.KEY_COOKIE, getCookie());
                    request.params.put(Constant.KEY_AUTH_TOKEN, SPref.getInstance().getToken(context));
