...
public class HashtagVideosAdapter extends RecyclerView.Adapter<HashtagVideosAdapter.ContactHolder> {
   ...
   /* @Override
    ...
    public HashtagVideosAdapter(List<Videos> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr) {
        this.list = list;
        this.listCat = null;
        this.context = cntxt;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            holder.cvMain.setOnClickListener(v -> listener.onItemClicked(Constant.Events.STICKER_USER, "" + vo.getTitle(), holder.getAdapterPosition()));
        } catch (Exception e) {
            CustomLog.e(e);
        }
    }
