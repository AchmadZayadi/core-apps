...
public class MeAdapter2 extends RecyclerView.Adapter<MeAdapter2.ContactHolder> {
    ...
    public MeAdapter2(List<Videos> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
...
//            holder..setOnClickListener(v -> listener.onItemClicked(Constant.Events.PROFILE, "", vo.getOwnerId()));
          ...
          /*  holder.ivLike.setOnClickListener(v -> {
                ...
                if (vo.isContentLike()) {
                    ...
                    holder.ivLike.setColorFilter(ContextCompat.getColor(context, R.color.gplus_color_3));
