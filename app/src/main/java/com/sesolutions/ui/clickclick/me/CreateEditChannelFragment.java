...
public class CreateEditChannelFragment extends FormHelper implements View.OnClickListener {//}, ParserCallbackInterface {
   ...
   /* public static CreateEditPageFragment newInstance(int formType, String url, int categoryId) {
    ...
    public static CreateEditChannelFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result) {
        CreateEditChannelFragment fragment = new CreateEditChannelFragment();
    ...
    public static CreateEditChannelFragment newInstance(int type, Map<String, Object> map, String url, Dummy.Result result, Boolean showToolbar) {
        CreateEditChannelFragment fragment = new CreateEditChannelFragment();
        fragment.FORM_TYPE = type;
        fragment.url = url;
        fragment.map = map;
    ...
    private void init() {
        ...
        ((TextView) v.findViewById(R.id.tvTitle)).setText(getStrings(FORM_TYPE == Constant.FormType.ADD_CHANNEL ? R.string.title_create_channel : R.string.title_edit_channel));
