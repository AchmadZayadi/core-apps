...
public class MeAdapterMusic extends RecyclerView.Adapter<MeAdapterMusic.ContactHolder> {
    ...
    public MeAdapterMusic(List<Videos> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
    ...
    public ContactHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_simmiler_music, parent, false);
