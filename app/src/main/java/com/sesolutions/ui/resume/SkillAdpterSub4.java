...
public class SkillAdpterSub4 extends RecyclerView.Adapter<SkillAdpterSub4.ContactHolder> {

    private final List<SkillParentModel.ResultBean.HobbiesBean> list;
   ...
   /* @Override
    ...
    public SkillAdpterSub4(List<SkillParentModel.ResultBean.HobbiesBean> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr) {
        this.list = list;
        this.listCat = null;
        this.context = cntxt;
    ...
    public SkillAdpterSub4(List<Category> list, OnUserClickedListener<Integer, Object> listenr, Context context) {
        this.listCat = list;
        this.list = null;
    ...
    public void onBindViewHolder(@NonNull final ContactHolder holder, int position) {
        ...
        try {
            ...
            holder.titleview.setText(""+list.get(position).getHobbiename());
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.editmanue:
                                    //handle menu1 click
                                    listener.onItemClicked(Constant.Events.CLICKED_HEADER_EDIT, list.get(position), 3);
                                    break;
                                case R.id.deletemanue:
                                    //handle menu2 click
                                    listener.onItemClicked(Constant.Events.CLICKED_HEADER_DELETE, list.get(position),3);
                                    break;
                            }
                            return false;
                        }
