...
public class MyVideoFragment2 extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, Object> {
    ...
    public MyVideoAdapter2 adapter;
    public View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_my_album2, container, false);
        //applyTheme(v);
        setstusbar();
        initScreenData(0);
...
// finally change the color
    ...
    private void init() {
        try {
            ...
            v.findViewById(R.id.llToggleV).setVisibility(View.GONE);
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new MyVideoAdapter2(lists, context, this, this, Constant.FormType.TYPE_MY_ALBUMS);
                            ...
                            try {
                                ...
                                if (response != null) {
                                    ...
                                    if (TextUtils.isEmpty(err.getError())) {
                                        ...
                                        tvTitle.setText("Video"+"("+lists.size()+")");
                                        updateAdapter();
                                    } else {
    ...
    public static MyVideoFragment2 newInstance(OnUserClickedListener<Integer, Object> parent, String selectedScreen) {
        MyVideoFragment2 frag = new MyVideoFragment2();
