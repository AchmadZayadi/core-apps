...
public class ViewMultiStoreReviewFragment extends MultiStoreHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_multireview, container, false);
        applyTheme();

        continueriding=v.findViewById(R.id.continueriding);
        llbottomid=v.findViewById(R.id.llbottomid);
        continueriding.setVisibility(View.GONE);
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
    ...
    public static ViewMultiStoreReviewFragment newInstance(int albumId, boolean comment) {
        ViewMultiStoreReviewFragment frag = new ViewMultiStoreReviewFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewMultiStoreReviewFragment newInstance(int albumId, Bundle bundle) {
        ViewMultiStoreReviewFragment frag = new ViewMultiStoreReviewFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewMultiStoreReviewFragment newInstance(int albumId) {
        return ViewMultiStoreReviewFragment.newInstance(albumId, false);
    }
