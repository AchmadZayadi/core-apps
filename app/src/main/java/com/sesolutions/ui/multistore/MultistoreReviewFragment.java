...
public class MultistoreReviewFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String>, SwipeRefreshLayout.OnRefreshListener {
    ...
    private MultistoreReviewAdapter adapter;
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new MultistoreReviewAdapter(categoryList, context, this, this, Constant.FormType.TYPE_MULTISTORE_CATEGORY);
    ...
    public static MultistoreReviewFragment newInstance(MultiStoreParentFragment parent) {
        MultistoreReviewFragment frag = new MultistoreReviewFragment();
        frag.parent = parent;
        return frag;
    }

    public static MultistoreReviewFragment newInstance() {
        MultistoreReviewFragment frag = new MultistoreReviewFragment();
        return frag;
    }
    ...
    private void goToCategoryFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewMultiStoreReviewFragment.newInstance(12,true))
                .addToBackStack(null)
                .commit();
    }
}
