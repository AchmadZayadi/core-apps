...
public class MultistoreExpertBrowseFragment extends BaseFragment implements View.OnClickListener, OnLoadMoreListener, OnUserClickedListener<Integer, String>, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setRecyclerView() {
        try {
            ...
            adapter = new CategoryAdapter(categoryList, context, this, this, Constant.FormType.TYPE_MULTISTORE_EXPERT_CATEGORY);
    ...
    public static MultistoreExpertBrowseFragment newInstance(MultiStoreParentFragment parent) {
        MultistoreExpertBrowseFragment frag = new MultistoreExpertBrowseFragment();
        frag.parent = parent;
        return frag;
    }
    ...
    public boolean onItemClicked(Integer object1, String object2, int postion) {
        switch (object1) {
            case Constant.Events.MUSIC_MAIN:
                String screentype=object2;
                if(screentype.equalsIgnoreCase(""+Constant.FormType.TYPE_MULTISTORE_EXPERT_CATEGORY)){
                    goToCategoryExpertFragment(postion);
                }else {
    ...
    private void goToCategoryExpertFragment(int postion) {
        fragmentManager.beginTransaction()
                .replace(R.id.container
                        , ViewMultiStoreExpertFragment.newInstance(categoryList.get(postion).getCategoryId(), categoryList.get(postion).getLabel()))
                .addToBackStack(null)
                .commit();
    }
