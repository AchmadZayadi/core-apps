...
public class ViewMultiStoreWishlistFragment extends MultiStoreHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
    ...
    private TextView tvTitle,tvTitletag;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.view_multistore_wishlist, container, false);
        applyTheme();
        iconFont = FontManager.getTypeface(context, FontManager.FONTAWESOME);
        listingtext=v.findViewById(R.id.listingtext);
        tvTitletag=v.findViewById(R.id.tvTitletag);
        listingtext.setTypeface(iconFont);
        listingtext.setText(Constant.FontIcon.VIEWTAG+" 02  "+Constant.FontIcon.MESSAGE+" 08  "+Constant.FontIcon.LIKE+" 05  "+Constant.FontIcon.FAVRATE+" 12  "+Constant.FontIcon.STARMARK+" 21");
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
    ...
    public static ViewMultiStoreWishlistFragment newInstance(int albumId, boolean comment) {
        ViewMultiStoreWishlistFragment frag = new ViewMultiStoreWishlistFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewMultiStoreWishlistFragment newInstance(int albumId, Bundle bundle) {
        ViewMultiStoreWishlistFragment frag = new ViewMultiStoreWishlistFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewMultiStoreWishlistFragment newInstance(int albumId) {
        return ViewMultiStoreWishlistFragment.newInstance(albumId, false);
    }
