...
public class ViewMultiStoreCategoryFragment extends MutistoreFragment implements View.OnClickListener, OnLoadMoreListener {
    ...
    public static ViewMultiStoreCategoryFragment newInstance(int categoryId, String categoryName) {
        ViewMultiStoreCategoryFragment frag = new ViewMultiStoreCategoryFragment();
        frag.parent = null;
