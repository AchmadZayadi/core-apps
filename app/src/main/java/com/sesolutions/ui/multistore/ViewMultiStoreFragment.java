...
public class ViewMultiStoreFragment extends MultiStoreHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener {
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
    ...
    public static ViewMultiStoreFragment newInstance(int albumId, boolean comment) {
        ViewMultiStoreFragment frag = new ViewMultiStoreFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewMultiStoreFragment newInstance(int albumId, Bundle bundle) {
        ViewMultiStoreFragment frag = new ViewMultiStoreFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewMultiStoreFragment newInstance(int albumId) {
        return ViewMultiStoreFragment.newInstance(albumId, false);
    }
