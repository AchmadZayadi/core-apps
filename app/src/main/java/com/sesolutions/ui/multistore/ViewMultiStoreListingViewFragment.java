...
public class ViewMultiStoreListingViewFragment extends MultiStoreHelper implements View.OnClickListener, OnLoadMoreListener, PopupMenu.OnMenuItemClickListener,TabLayout.OnTabSelectedListener {
    ...
    LinearLayout llbottomid;

    private ViewPager viewPager;
    private TabLayout tabLayout;
    private MessageDashboardViewPagerAdapter adaptertab;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        v = inflater.inflate(R.layout.fragment_view_multilisting, container, false);
        applyTheme();

        llbottomid=v.findViewById(R.id.llbottomid);
        llbottomid.setVisibility(View.VISIBLE);
...
//            collapsingToolbar.setTitle(album.getTitle());
   ...
   /* private void unfilledAllStar() {
    ...
    public static ViewMultiStoreListingViewFragment newInstance(int albumId, boolean comment) {
        ViewMultiStoreListingViewFragment frag = new ViewMultiStoreListingViewFragment();
        frag.albumId = albumId;
        frag.openComment = comment;
        return frag;
    }

    public static ViewMultiStoreListingViewFragment newInstance(int albumId, Bundle bundle) {
        ViewMultiStoreListingViewFragment frag = new ViewMultiStoreListingViewFragment();
        frag.albumId = albumId;
        frag.bundle = bundle;
        return frag;
    ...
    public static ViewMultiStoreListingViewFragment newInstance(int albumId) {
        return ViewMultiStoreListingViewFragment.newInstance(albumId, false);
    }
   ...
   /* public void loadMore() {
    ...
    private void setupViewPager() {
        try {
            ...
            adaptertab = new MessageDashboardViewPagerAdapter(fragmentManager);
            adaptertab.showTab(true);
            adaptertab.addFragment(Multilisting_photo_fragment.newInstance(11, false), "Photos");
            adaptertab.addFragment(Multilisting_photo_fragment.newInstance(11, false), "Reviews");
            adaptertab.addFragment(Multilisting_photo_fragment.newInstance(11, false), "Videos");
            adaptertab.addFragment(Multilisting_photo_fragment.newInstance(11, false), "Experts Reviews");
