...
public class BrowsewishlistMutistoreFragment extends MultiStoreHelper implements View.OnClickListener, OnLoadMoreListener {
    ...
    public void setRecyclerView() {
        try {
            ...
            adapter = new MultiStoreAdapter(videoList, context, this, this,  Constant.FormType.BROWSE_STOREWISHLIST);
    ...
    public static BrowsewishlistMutistoreFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId, int categoryId) {
        BrowsewishlistMutistoreFragment frag = new BrowsewishlistMutistoreFragment();
        frag.parent = parent;
    ...
    public static BrowsewishlistMutistoreFragment newInstance(OnUserClickedListener<Integer, Object> parent, int loggedInId) {
        return newInstance(parent, loggedInId, -1);
    }

    public static BrowsewishlistMutistoreFragment newInstance(int categoryId) {
