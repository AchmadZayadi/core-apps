...
public class MultiStoreMyListingAdpter extends RecyclerView.Adapter<MultiStoreMyListingAdpter.ContactHolder> {
    ...
    @Override
    public void onViewAttachedToWindow(MultiStoreMyListingAdpter.ContactHolder holder) {
    ...
    public MultiStoreMyListingAdpter(List<Blog> list, Context cntxt, OnUserClickedListener<Integer, Object> listenr, OnLoadMoreListener loadListener, final int SCREEN_TYPE) {
        this.list = list;
        this.context = cntxt;
