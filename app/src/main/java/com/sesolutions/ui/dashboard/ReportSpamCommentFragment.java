...
public class ReportSpamCommentFragment extends BaseFragment implements View.OnClickListener {//}, ParserCallbackInterface {
    ...
    private void init() {
        if (!showbar) {
            ...
            tvTitle.setText("Laporkan Komentar");
        }
...
// build and display the form
    ...
    public static Fragment newInstance(String guid) {
        ReportSpamCommentFragment fragment = new ReportSpamCommentFragment();
        fragment.guid = guid;
        return fragment;
    }
