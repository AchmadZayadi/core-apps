...
public class UnggahFotoFragment extends ApiHelper implements View.OnClickListener, OnUserClickedListener<Integer, Object>, TextWatcher, SlidingUpPanelLayout.PanelSlideListener, SwipeRefreshLayout.OnRefreshListener, OnKeyboardVisibilityListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener/*, MyMultiPartEntity.ProgressListener*/ {
    ...
    public static UnggahFotoFragment newInstance(ComposerOption response, int selectedOption) {
        return newInstance(response, selectedOption, 0, null);
    }

    public static UnggahFotoFragment newInstance(ComposerOption response, int selectedOption, List<String> photopath) {
        UnggahFotoFragment frag = new UnggahFotoFragment();
    ...
    public static UnggahFotoFragment newInstance(ComposerOption response, int selectedOption, List<String> photopath, String resType, int resId) {
        UnggahFotoFragment frag = new UnggahFotoFragment();
        frag.composerOption = response;
        frag.selectedOption = selectedOption;
        frag.photopath = photopath;
    ...
    public static UnggahFotoFragment newInstance(ComposerOption response, int selectedOption, int resId, String resType) {
...
//                        .show();
    ...
    private void showBgImageGridOption() {
        startAnimation(cvBgImageGrid, Techniques.SLIDE_IN_UP, 400, new AnimationAdapter() {
            @Override
            public void onAnimationStart(Animator animation) {
                mLayout.removePanelSlideListener(UnggahFotoFragment.this);
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                mLayout.addPanelSlideListener(UnggahFotoFragment.this);
            }
        });
    }
                        ...
                        if (null != response) {
                            ...
                            if (TextUtils.isEmpty(resp.getError())) {
                             ...
                             /*   if (videoDetail != null && videoDetail.isFromDevice()) {
                                ...
                                Constant.TASK_POST = true;
                                //UnggahFotoFragment.super.onBackPressed();
                                onBackPressed();
