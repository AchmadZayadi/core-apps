...
class ForumHomeAdapter(private val list: List<ForumResponse.Category>,
                       private val context: Context,
                       private val listener: OnUserClickedListener<Int, Any>,
                       private val loadListener: OnLoadMoreListener) : androidx.recyclerview.widget.RecyclerView.Adapter<ForumHomeAdapter.CategoryHolder>() {
        ...
        try {
            ...
            if ( cVo.subcat!!.isNotEmpty()) {
                ...
                if (holder.subAdapter == null) {
                    ...
                    holder.subAdapter = SubCategoryAdapter(cVo.subcat!!, context, listener, loadListener)
            ...
            holder.cvMain.setOnClickListener {
                ...
                ForumCategoryViewFragment.breadCrumbList.add(cVo)
