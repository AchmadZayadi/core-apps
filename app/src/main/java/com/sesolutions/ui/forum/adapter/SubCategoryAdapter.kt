...
class SubCategoryAdapter(private val list: List<ForumResponse.Category>,
                         private val context: Context,
                         private val listener: OnUserClickedListener<Int, Any>,
                         private val loadListener: OnLoadMoreListener) : androidx.recyclerview.widget.RecyclerView.Adapter<SubCategoryAdapter.CategoryHolder>() {
