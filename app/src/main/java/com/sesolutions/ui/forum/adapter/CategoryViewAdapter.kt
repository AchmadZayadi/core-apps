...
class CategoryViewAdapter(private val list: List<ForumVo>,
        ...
        try {
            when (list[position].type) {
                ...
                VT_FORUM -> {
                    ...
                    val forumVo = list[position]
                    val forum = forumVo.getValue<ForumResponse.ForumContent>()
                ...
                VT_TOPIC -> {
                    ...
                    val vo = fVo.getValue<ForumResponse.Topic>()
                    ...
                    val vo = content.getValue<ForumResponse.Category>()
                    ...
                    if (null != vo.subsubcat && vo.subsubcat.isNotEmpty()) {
                        ...
                        if (holder.subAdapter == null) {
                            ...
                            holder.subAdapter = SubCategoryAdapter(vo.subsubcat, context, listener, loadListener)
                    ...
                    holder.cvMain.setOnClickListener { v ->
                        ...
                        ForumCategoryViewFragment.breadCrumbList.add(vo)
                    }
                }
            }
        } catch (e: Exception) {
    ...
    inner class CategoryHolder(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView) {
        ...
        var subAdapter: SubCategoryAdapter? = null
    }
