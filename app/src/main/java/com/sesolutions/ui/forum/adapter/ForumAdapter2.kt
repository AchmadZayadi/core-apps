...
class ForumAdapter2(private val list: List<ForumResponse2.Topic>,
                    private val context: Context,
                    private val listener: OnUserClickedListener<Int, Any>,
                    private val loadListener: OnLoadMoreListener) : androidx.recyclerview.widget.RecyclerView.Adapter<ForumAdapter2.CategoryHolder>() {
