package com.sesolutions.animate.bounceview;
...
public class BounceView implements BounceViewAnim {
    ...
    public static void applyBounceEffectTo(View view) {
        BounceView bounceAnim = new BounceView(view);
        bounceAnim.setAnimToView();
        bounceAnim.setPopOutAnimDuration(150)
                .setScaleForPushInAnim(.9f, .85f)
