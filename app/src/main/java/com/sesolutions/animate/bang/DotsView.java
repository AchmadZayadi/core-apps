package com.sesolutions.animate.bang;
...
public class DotsView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        centerX = w / 2;
        centerY = h / 2;
        maxDotSize = dp2px(getContext(), 1.1f);
    ...
    private void updateInnerDotsPosition() {
        ...
        if (currentProgress < 0.2) {
            ...
            this.currentDotSize2 = (float) mapValueFromRangeToRange(currentProgress, 0.2f, 0.5f, maxDotSize, 0.5 * maxDotSize);
        } else {
            this.currentDotSize2 = (float) mapValueFromRangeToRange(currentProgress, 0.5f, 1f, maxDotSize * 0.5f, 0);
        }
