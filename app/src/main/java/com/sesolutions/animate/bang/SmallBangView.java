...
public class SmallBangView extends FrameLayout {
    ...
    public void likeAnimation(Animator.AnimatorListener listener) {
        ...
        outerCircleAnimator.setDuration(400);

        ObjectAnimator starScaleAnimator = ObjectAnimator.ofFloat(scaleView, SCALE, 0.2f, 1f);
        starScaleAnimator.setDuration(400);
        starScaleAnimator.setStartDelay(400);
        ...
        animatorSet.start();
        MediaPlayer.create(getContext(), R.raw.reaction).start();
        if (listener != null) {
