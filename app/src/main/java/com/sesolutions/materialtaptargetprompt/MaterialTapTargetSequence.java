...
import com.sesolutions.materialtaptargetprompt.extras.PromptOptions;
import com.sesolutions.materialtaptargetprompt.extras.sequence.SequenceItem;
import com.sesolutions.materialtaptargetprompt.extras.sequence.SequenceItemShowFor;
import com.sesolutions.materialtaptargetprompt.extras.sequence.SequenceState;
import com.sesolutions.materialtaptargetprompt.extras.sequence.SequenceStatePromptOptions;
...
public class MaterialTapTargetSequence
{
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence setSequenceCompleteListener(@Nullable SequenceCompleteListener listener)
    {
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence addPrompt(@Nullable MaterialTapTargetPrompt prompt)
    {
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence addPrompt(@NonNull PromptOptions promptOptions)
    {
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence addPrompt(@NonNull final SequenceItem item)
    {
        this.items.add(item);
        return this;
    }
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence show()
    {
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence finish()
    {
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence dismiss()
    {
        if (this.nextPromptIndex > -1 && this.nextPromptIndex < this.items.size())
        {
            final SequenceItem sequenceItem = this.items.get(nextPromptIndex);
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.MaterialTapTargetSequence showFromIndex(final int index)
    {
        this.dismiss();
        this.show(index);
        return this;
