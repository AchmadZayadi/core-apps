...
package com.sesolutions.materialtaptargetprompt.extras.backgrounds;
...
import com.sesolutions.materialtaptargetprompt.extras.PromptBackground;
...
public class FullscreenPromptBackground extends PromptBackground
{
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.extras.backgrounds.FullscreenPromptBackground setCornerRadius(final float rx, final float ry)
    {
        mRx = rx;
        mRy = ry;
        return this;
