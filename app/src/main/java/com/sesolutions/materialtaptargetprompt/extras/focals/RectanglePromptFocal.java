...
package com.sesolutions.materialtaptargetprompt.extras.focals;
...
import com.sesolutions.materialtaptargetprompt.extras.PromptFocal;
import com.sesolutions.materialtaptargetprompt.extras.PromptOptions;
import com.sesolutions.materialtaptargetprompt.extras.PromptUtils;
...
public class RectanglePromptFocal extends PromptFocal
{
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.extras.focals.RectanglePromptFocal setCornerRadius(final float rx, final float ry)
    {
        mRx = rx;
        mRy = ry;
        return this;
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.extras.focals.RectanglePromptFocal setTargetPadding(@Dimension final float padding)
    {
        mPadding = padding;
        return this;
    }
     ...
     */
    @NonNull
    public com.sesolutions.materialtaptargetprompt.extras.focals.RectanglePromptFocal setSize(@Nullable final PointF size)
    {
        if (size == null)
        {
            mSize = null;
