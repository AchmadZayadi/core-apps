...
public class CropFragment extends BaseFrag implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(com.droidninja.imageeditengine.R.layout.fragment_crop, container, false);
    }
    ...
    protected void initView(View view) {
        cropImageView = view.findViewById(com.droidninja.imageeditengine.R.id.image_iv);
        view.findViewById(com.droidninja.imageeditengine.R.id.cancel_tv).setOnClickListener(this);
        view.findViewById(com.droidninja.imageeditengine.R.id.back_iv).setOnClickListener(this);
        view.findViewById(com.droidninja.imageeditengine.R.id.rotate_iv).setOnClickListener(this);
        view.findViewById(com.droidninja.imageeditengine.R.id.done_tv).setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (view.getId() == com.droidninja.imageeditengine.R.id.rotate_iv) {
            cropImageView.rotateImage(90);
        } else if (view.getId() == com.droidninja.imageeditengine.R.id.cancel_tv) {
            mListener.onCancelCrop();
        } else if (view.getId() == com.droidninja.imageeditengine.R.id.done_tv) {
