...
public class MoreFragment extends BaseFrag implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.layout_toolbar_list_refresh_offset, container, false);
    }
    ...
    public static MoreFragment newInstance(Bitmap bitmap, Rect cropRect) {
        MoreFragment cropFragment = new MoreFragment();
