...
public class BusinessContent {
    ...
    @SerializedName("business_contact_pinterest")
    private String business_contact_pinterest;
    @SerializedName("business_contact_instagram")
    private String business_contact_instagram;
    @SerializedName("business_contact_linkedin")
    private String business_contact_linkedin;
    @SerializedName("business_contact_twitter")
    private String business_contact_twitter;
    @SerializedName("business_contact_facebook")
    private String business_contact_facebook;
    @SerializedName("business_contact_website")
    private String business_contact_website;
    @SerializedName("business_contact_phone")
    private String business_contact_phone;
    @SerializedName("business_contact_email")
    ...
    public String getBusiness_contact_pinterest() {
        return business_contact_pinterest;
    }

    public String getBusiness_contact_instagram() {
        return business_contact_instagram;
    }

    public String getBusiness_contact_linkedin() {
        return business_contact_linkedin;
    }

    public String getBusiness_contact_twitter() {
        return business_contact_twitter;
    }

    public String getBusiness_contact_facebook() {
        return business_contact_facebook;
    }

    public String getBusiness_contact_website() {
        return business_contact_website;
    }

    public String getBusiness_contact_phone() {
        return business_contact_phone;
    }
