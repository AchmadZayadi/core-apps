...
public class GroupContent {
    ...
    @SerializedName("group_contact_pinterest")
    private String group_contact_pinterest;
    @SerializedName("group_contact_instagram")
    private String group_contact_instagram;
    @SerializedName("group_contact_linkedin")
    private String group_contact_linkedin;
    @SerializedName("group_contact_twitter")
    private String group_contact_twitter;
    @SerializedName("group_contact_facebook")
    private String group_contact_facebook;
    @SerializedName("group_contact_website")
    private String group_contact_website;
    @SerializedName("group_contact_phone")
    private String group_contact_phone;
    @SerializedName("group_contact_email")
    private String group_contact_email;
    @SerializedName("group_contact_name")
    private String group_contact_name;
