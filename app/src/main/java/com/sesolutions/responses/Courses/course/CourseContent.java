...
public class CourseContent {
    ...
    private String price_with_discount;
    @SerializedName("classroom_logo")
    ...
    @SerializedName("is_content_wishlist")
    private boolean iscontentwishlist;
    private Share share;
    ...
    public boolean canWishlist() {
        return iscontentwishlist;
    }
