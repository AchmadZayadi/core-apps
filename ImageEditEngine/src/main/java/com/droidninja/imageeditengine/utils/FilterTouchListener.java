    ...
    public boolean onTouch(View v, MotionEvent e) {
        ...
        switch (action & e.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                photoEditorView.getListener().onItemClicked(Constants.Events.TASK, null, Constants.TASK_HIDE_CAPTION);
                break;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (diff < middle) {
                    ...
                    photoEditorView.getListener().onItemClicked(Constants.Events.TASK, null, Constants.TASK_SHOW_CAPTION);
                } else {
