 ...
 */
public abstract class Jzvd2 extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {

    public static final String TAG = "JZVD";
    public static Jzvd2 CURRENT_JZVD;
    ...
    public JZMediaInterface2 mediaInterface;
    ...
    public JZTextureView2 textureView;
    ...
    public Jzvd2(Context context) {
        super(context);
        init(context);
    }

    public Jzvd2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//        mediaInterface.prepare();
    ...
    public void onInfo(int what, int extra) {
        ...
        if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
            ...
            if (state == Jzvd2.STATE_PREPARED
                    || state == Jzvd2.STATE_PREPARING_CHANGE_URL) {
    ...
    public void startVideo() {
        ...
        setCurrentJzvd(this);
        try {
            Constructor<JZMediaInterface2> constructor = mediaInterfaceClass.getConstructor(Jzvd2.class);
    ...
    public void addTextureView() {
        ...
        textureView = new JZTextureView2(getContext().getApplicationContext());
    ...
    public void onVideoSizeChanged(int width, int height) {
        ...
        float height22 = displayMetrics.heightPixels / displayMetrics.density;
        float width33 = displayMetrics.widthPixels / displayMetrics.density;


        Log.e("video"+width,"he:"+height);
       Log.e("video2"+width33,"he2:"+height22);
        width=720;
        height=1080;
...
//        Log.d(TAG, "onProgress: progress=" + progress + " position=" + position + " duration=" + duration);
    ...
    public void cloneAJzvd(ViewGroup vg) {
        try {
            Constructor<Jzvd2> constructor = (Constructor<Jzvd2>) Jzvd2.this.getClass().getConstructor(Context.class);
            Jzvd2 jzvd = constructor.newInstance(getContext());
            jzvd.setId(getId());
            vg.addView(jzvd);
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
    ...
    public static void setCurrentJzvd(Jzvd2 jzvd) {
    ...
    public static void setVideoImageDisplayType(int type) {
        Jzvd2.VIDEO_IMAGE_DISPLAY_TYPE = type;
        if (CURRENT_JZVD != null && CURRENT_JZVD.textureView != null) {
