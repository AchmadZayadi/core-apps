 ...
 * On 2016/04/18 16:15
 */
public class JzvdStd2 extends Jzvd2 {
    ...
    public LinearLayout mReactionLayout;
    public TextView tvUserId;
    public TextView tvDescription,tvTitle,tvTAg;
    public TextView tvMusic;
    public ImageView ivViews;
    ...
    public RelativeLayout ivFollowId;
    ...
    public JzvdStd2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void init(Context context) {
        ...
        mStatsLayout = findViewById(R.id.stats_layout);
        ...
        ivFollowId = findViewById(R.id.ivFollowId);
        try {
    ...
    public void changeUiToNormal() {
        Log.e("454545","changeUiToNormal");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.VISIBLE, View.INVISIBLE, View.INVISIBLE, View.VISIBLE);
                updateStartImage();
                break;
            case SCREEN_TINY:
                break;
    ...
    public void changeUiToPreparing() {
        Log.e("454545","changeUiToPreparing");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.VISIBLE, View.VISIBLE, View.INVISIBLE, View.INVISIBLE, View.VISIBLE);
                updateStartImage();
                break;
            case SCREEN_TINY:
                break;
    ...
    public void changeUIToPreparingPlaying() {
        Log.e("454545","changeUIToPreparingPlaying");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
    ...
    public void changeUIToPreparingChangeUrl() {
        Log.e("454545","changeUIToPreparingChangeUrl");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
    ...
    public void changeUiToPlayingShow() {
        Log.e("454545","changeUiToPlayingShow");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
    ...
    public void changeUiToPlayingClear() {
        Log.e("454545","changeUiToPlayingClear");

        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.INVISIBLE, View.INVISIBLE, View.VISIBLE, View.INVISIBLE, View.VISIBLE);
                break;
            case SCREEN_TINY:
                break;
        }
    ...
    public void changeUiToPauseShow() {
        Log.e("454545","changeUiToPauseShow");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
    ...
    public void changeUiToPauseClear() {
        Log.e("454545","changeUiToPauseClear");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
    ...
    public void changeUiToComplete() {
        Log.e("454545","changeUiToComplete");
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
    ...
    public void changeUiToError() {
        Log.e("454545","changeUiToError");
        switch (screen) {
            case SCREEN_NORMAL:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.VISIBLE,
                        View.INVISIBLE, View.INVISIBLE, View.INVISIBLE, View.VISIBLE, View.VISIBLE);
                updateStartImage();
                break;
            case SCREEN_FULLSCREEN:
                setAllControlsVisiblity(View.VISIBLE, View.INVISIBLE, View.VISIBLE,
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
                                        int thumbImg, int bottomPro, int retryLayout, int statslayout) {
        topContainer.setVisibility(topCon);
        bottomContainer.setVisibility(bottomCon);
        Log.e("startBtn",""+startBtn);
        startButton.setVisibility(startBtn);
        loadingProgressBar.setVisibility(loadingPro);
        thumbImageView.setVisibility(thumbImg);
        bottomProgressBar.setVisibility(bottomPro);
        mRetryLayout.setVisibility(retryLayout);
        mStatsLayout.setVisibility(statslayout);
        mReactionLayout.setVisibility(statslayout);

        Animation aniRotate = AnimationUtils.loadAnimation(getContext(), R.anim.img_clock);

        try {
            if(startBtn==0){
                ivUser.clearAnimation();
            }else {
                ivUser.startAnimation(aniRotate);
            }
        }catch (Exception ex){
            ex.printStackTrace();
        }
