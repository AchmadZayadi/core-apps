...
public class FormElementButtonViewHolder extends BaseViewHolder {
    ...
    public FormElementButtonViewHolder(View v) {
        super(v);
        mButton = (AppCompatButton) v.findViewById(R.id.formElementButton);
        tvText = (AppCompatTextView) v.findViewById(R.id.tvText);
    }

    @Override
    public void bind(int position, final BaseFormElement formElement, final Context context) {

        mButton.setText(formElement.getTitle());
        tvText.setVisibility(((FormElementButton) formElement).isTextEmpty() ? View.GONE : View.VISIBLE);
        tvText.setText(((FormElementButton) formElement).getButtonText());
        tvText.setMovementMethod(LinkMovementMethod.getInstance());
        mButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    ((FormElementButton) formElement).getClickListener().onTextClicked(formElement.getTag());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
