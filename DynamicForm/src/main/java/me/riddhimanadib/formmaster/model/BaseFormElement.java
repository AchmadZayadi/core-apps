...
public class BaseFormElement {
    ...
    public static final int TYPE_LOCATION_SUGGEST = 15;
    public static final int TYPE_EDITOR = 16;
    public static final int TYPE_MUSIC_FILE = 17;
    public static final int TYPE_RATING = 18;
    public static final int TYPE_TITLE = 19;
    public static final int TYPE_GROUP_QUESTION = 20;
    public static final int TYPE_UNEDITABLE_TEXT = 21;
    public static final int TYPE_UNEDITABLE_TEXT_CENTER = 22;
    public static final int TYPE_URL= 23;
    public static final int TYPE_IMAGE_TYPE= 231;
    ...
    public BaseFormElement setWordlength(int wordlength) {
    ...
    public BaseFormElement setName(String mName) {
        this.mName = mName;
        return this;
    }
    ...
    public BaseFormElement setHidden(boolean isHidden) {
