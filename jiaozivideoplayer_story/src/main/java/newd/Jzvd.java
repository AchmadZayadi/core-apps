...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public ImageView muteButton, unMuteButton;
    public SeekBar progressBar;
    public ImageView fullscreenButton;
    public TextView currentTimeTextView, totalTimeTextView;
    public ViewGroup textureViewContainer;
    public ViewGroup topContainer, bottomContainer, muteContainer;
...
//                JZVideoPlayer.releaseAllVideos();
    ...
    public void init(Context context) {
        ...
        muteContainer = findViewById(R.id.mute_layout);
    ...
    public void onClick(View v) {
        try {
            ...
            if (i == R.id.start) {
                ...
                onEvent(JZUserAction.ON_MUTE_AUDIO);
                Log.d(TAG, "onClick: mute [" + this.hashCode() + "] ");
                JZMediaManager.mute();
                unMuteButton.setVisibility(View.VISIBLE);
                muteButton.setVisibility(View.GONE);

            } else if (i == R.id.unmute) {
                onEvent(JZUserAction.ON_UNMUTE_AUDIO);
                Log.d(TAG, "onClick: unmute [" + this.hashCode() + "] ");
                JZMediaManager.unmute();
...
//                        mDownY = y;
    ...
    public void onPrepared() {
        ...
        onStatePrepared();
        onStatePlaying();
        muteContainer.setVisibility(View.GONE);
        if (mPlayMute)
...
//        removeTextureView();
    ...
    abstract public boolean showWifiDialog();
